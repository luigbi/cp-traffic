...
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of Cspword.frm on Wed 6/17/09 @ 12:56 PM
...
'
    ...
    '    End If
        '4/24/14: Allow difference message
        ...
        If Left(sgPasswordAddition, 8) = "Replace:" Then
            lacPrev.Caption = "Current Keycode is " & Trim$(str$(imPasswordValue)) & ". " & Mid(sgPasswordAddition, 9)
        Else
            lacPrev.Caption = "Current Keycode is " & Trim$(sgPasswordAddition) & Trim$(str$(imPasswordValue)) & ", Leave New Keycode Blank for View Mode Only.  Obtain New Keycode from Counterpoint Software"
        End If
    'End If
