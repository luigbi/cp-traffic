...
Private Sub mInit()
    ...
    If Not ogReport Is Nothing Then
        ...
        '5875
        smFileName = Replace(smFileName, "generic\", "", , , vbTextCompare)
...
Private Sub cmcUserChoice_Click(Index As Integer)
    ...
    'TTP 10411 - Proposals/Contracts report and Snapshot: failed to export error/permission denied error followed by crash when displaying then pressing Save button twice when attempting to save to file
    cmcUserChoice(0).Enabled = False
    cmcUserChoice(1).Enabled = False
