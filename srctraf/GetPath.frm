...
'
    ...
    'gCenterForm GetPath
    GetPath.Top = lgCallTop + (lgCallHeight - GetPath.Height) / 2
    GetPath.Left = lgCallLeft + (lgCallWidth - GetPath.Width) / 2
...
Private Sub Form_Unload(Cancel As Integer)
    Set GetPath = Nothing   'Remove data segment
End Sub
