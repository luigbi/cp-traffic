VERSION 5.00
Begin VB.UserControl CSI_ComboBoxList 
   ...
   ScaleHeight     =   1830
   ScaleWidth      =   3555
   ToolboxBitmap   =   "CSI_ComboBoxList.ctx":0000
   ...
   Begin VB.ListBox lbcList 
      Height          =   840
      ItemData        =   "CSI_ComboBoxList.ctx":00FA
      Left            =   0
      List            =   "CSI_ComboBoxList.ctx":0101
      TabIndex        =   0
      TabStop         =   0   'False
      Top             =   480
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "CSI_ComboBoxList"
