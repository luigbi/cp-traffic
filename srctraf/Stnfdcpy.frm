...
Begin VB.Form StnFdCpy 
   ...
   End
End
Attribute VB_Name = "StnFdCpy"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of Stnfdcpy.frm on Wed 6/17/09 @ 12:56 P
...
Private Sub cmcExport_Click()
    ...
    Close #hmMsg
    'lacProcessing.Caption = "See: " & sgExportPath & "StnFdCpy.Txt" & " for Messages"
    lacProcessing.Caption = "See: " & sgDBPath & "Messages\" & "StnFdCpy.Txt" & " for Messages or use the Message Viewer."
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set StnFdCpy = Nothing   'Remove data segment
...
'
    ...
    gBtrvErrorMsg ilRet, "mInit (btrOpen)", StnFdCpy
    On Error GoTo 0
    ...
    'plcGauge.Move StnFdCpy.Width / 2 - plcGauge.Width / 2
    'cmcFileConv.Move StnFdCpy.Width / 2 - cmcFileConv.Width / 2
    'cmcCancel.Move StnFdCpy.Width / 2 - cmcCancel.Width / 2 - cmcCancel.Width
    'cmcReport.Move StnFdCpy.Width / 2 - cmcReport.Width / 2 + cmcReport.Width
    imBSMode = False
...
Private Function mOpenMsgFile() As Integer
    ...
    'slToFile = sgExportPath & "StnFdCpy.Txt"
    slToFile = sgDBPath & "Messages\" & "StnFdCpy.Txt"
                ...
                Do While ilRet = BTRV_ERR_NONE
                    ...
                    If ilCifOk Then
                        ...
                        If ilRet = BTRV_ERR_NONE Then
                            ...
                            slRecord = slRecord & "," & slAction
                            slRecord = slRecord & "," & slShortTitle
                            slRecord = slRecord & "," & gAdvtNameFilter(slAdvtName)
                            slRecord = slRecord & "," & Trim$(str$(tmCif.iLen))
                            slRecord = slRecord & "," & slISCI
                            Print #hmTo, slRecord
                        Else
