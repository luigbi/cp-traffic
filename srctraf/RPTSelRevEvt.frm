...
Begin VB.Form RptSelRevEvt 
   Appearance      =   0  'Flat
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Revenue By Event"
   ClientHeight    =   5925
   ClientLeft      =   165
   ClientTop       =   1305
   ClientWidth     =   9270
   ...
   Begin VB.Frame frcOption 
      Caption         =   "Revenue By Event Selection"
      Enabled         =   0   'False
      ForeColor       =   &H00000000&
      Height          =   4515
      Left            =   75
      ...
      Begin VB.PictureBox pbcSelC 
         ...
         Visible         =   0   'False
         Width           =   4710
         Begin V81TrafficReports.CSI_Calendar calEnd 
            Height          =   285
            Left            =   1920
            TabIndex        =   12
            Top             =   600
         ...
         Begin VB.CheckBox ckcSkip1 
            ...
            Width           =   660
         End
         Begin VB.PictureBox plcAirTimeNTR 
            Appearance      =   0  'Flat
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   240
            ...
            Top             =   2760
            Width           =   4365
            Begin VB.OptionButton rbcAirTimeNTR 
               Caption         =   "Both"
               ForeColor       =   &H80000008&
               Height          =   195
               Index           =   2
         ...
         Begin VB.Label lacWarning 
            Caption         =   "* Warning *  Revenue by Event Feature is Disabled"
            Height          =   255
            Left            =   120
            TabIndex        =   54
            Top             =   3720
      ...
      Begin VB.PictureBox pbcOption 
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   1500
            Index           =   5
            ItemData        =   "RPTSelRevEvt.frx":0000
            Left            =   120
            List            =   "RPTSelRevEvt.frx":0007
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   1500
            Index           =   4
            ItemData        =   "RPTSelRevEvt.frx":000E
            Left            =   2280
            List            =   "RPTSelRevEvt.frx":0015
            MultiSelect     =   2  'Extended
            TabIndex        =   51
            Top             =   2340
            Visible         =   0   'False
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   1500
            Index           =   3
            ItemData        =   "RPTSelRevEvt.frx":001C
            Left            =   2280
            List            =   "RPTSelRevEvt.frx":0023
            MultiSelect     =   2  'Extended
            TabIndex        =   31
            Top             =   2400
            Visible         =   0   'False
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   1500
            Index           =   2
            ItemData        =   "RPTSelRevEvt.frx":002A
            Left            =   2265
            List            =   "RPTSelRevEvt.frx":0031
            MultiSelect     =   2  'Extended
            TabIndex        =   35
            Top             =   2235
            Visible         =   0   'False
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   1500
            Index           =   1
            ItemData        =   "RPTSelRevEvt.frx":0038
            Left            =   120
            List            =   "RPTSelRevEvt.frx":003F
            MultiSelect     =   2  'Extended
            TabIndex        =   33
            Top             =   2235
            Visible         =   0   'False
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   1500
            Index           =   0
            ItemData        =   "RPTSelRevEvt.frx":0046
            Left            =   120
            List            =   "RPTSelRevEvt.frx":004D
            MultiSelect     =   2  'Extended
            TabIndex        =   29
            Top             =   300
            Width           =   3975
   ...
   End
End
Attribute VB_Name = "RptSelRevEvt"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of RptSelRevEvt.frm on Wed 6/17/09 @ 12:56 P
...
'
' File Name: RptSelRevEvt.Frm - Quarterly Booked Report
...
Dim smSubTotal1 As String
Dim smSubtotal2 As String
Dim smCalStart As String
Dim smCalEnd As String
'
...
Public Sub mFillSortOptions(cbcCombo As Control, ilShowNone As Integer)
        ...
        cbcCombo.AddItem smEventTitle1
        cbcCombo.AddItem smEventTitle2
        cbcCombo.AddItem smSubTotal1
        cbcCombo.AddItem smSubtotal2
...
Private Sub calEnd_CalendarChanged()
    smCalEnd = calEnd.Text
    mSetCommands
End Sub

Private Sub calStart_CalendarChanged()
    smCalStart = calStart.Text
    mSetCommands
End Sub
...
End Sub
'
'           this is always All Advertisers check box
...
End Sub
'
'           this is always All vehicles check box
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set RptSelRevEvt = Nothing   'Remove data segment
...
Private Sub lbcSelection_Click(Index As Integer)
    ...
    If Index = 0 Then           ' advt selected
        imSetAllSort1 = False
        ckcAllSort1.Value = vbUnchecked
        imSetAllSort1 = True
    ElseIf Index = 1 Then           'Event title 1
       
            imSetAllSort3 = False
            ckcAllSort3.Value = vbUnchecked
            imSetAllSort3 = True

    ElseIf Index = 2 Then               'event title 2
       
            imSetAllSort3 = False
            ckcAllSort3.Value = vbUnchecked
            imSetAllSort3 = True

    ElseIf Index = 3 Then                   'subtotal 1
        
            imSetAllSort3 = False
            ckcAllSort3.Value = vbUnchecked
            imSetAllSort3 = True

    ElseIf Index = 4 Then                   'subtotal 2
       
            imSetAllSort3 = False
            ckcAllSort3.Value = vbUnchecked
            imSetAllSort3 = True

    ElseIf Index = 5 Then                   'vehicle
        imSetAllSort2 = False
        ckcAllSort2.Value = vbUnchecked
        imSetAllSort2 = True
...
Dim slStr As String
    ...
    RptSelRevEvt.Caption = smSelectedRptName & " Report"
    ...
    If Not ((Asc(tgSaf(0).sFeatures2) And EVENTREVENUE) = EVENTREVENUE) Then
        lacWarning.Visible = True
    End If
    
    gCenterStdAlone RptSelRevEvt
End Sub
'*******************************************************
'*                                                     *
...
Dim slStr1 As String
    ...
    smEventTitle1 = "Visitor"
    smEventTitle2 = "Home"
    If Trim$(tgSaf(0).sEventTitle1) <> "" Then
        smEventTitle1 = Trim$(tgSaf(0).sEventTitle1)
    End If
    If Trim$(tgSaf(0).sEventTitle2) <> "" Then
        smEventTitle2 = Trim$(tgSaf(0).sEventTitle2)
    End If
    smSubTotal1 = "Subtotal 1"
    smSubtotal2 = "Subtotal 2"
    If Trim$(tgSaf(0).sEventSubtotal1) <> "" Then
        smSubTotal1 = Trim$(tgSaf(0).sEventSubtotal1)
    End If
    If Trim$(tgSaf(0).sEventSubtotal2) <> "" Then
        smSubtotal2 = Trim$(tgSaf(0).sEventSubtotal2)
    End If
    mFillSortOptions cbcSort1, False
    mFillSortOptions cbcSort2, True
    mFillSortOptions cbcSort3, True
    
    ilRet = gRptAdvtPop(RptSelRevEvt, lbcSelection(0))      'populate advt
    'ilRet = gRptAgencyPop(RptSelRevEvt, lbcSelection(1))       'populate agencies
    'ilRet = gRptMnfPop(RptSelRevEvt, "B", lbcSelection(2), tgMnfCodeCT(), sgMNFCodeTagCT)       'bus category
    'ilRet = gRptMnfPop(RptSelRevEvt, "C", lbcSelection(3), tgMNFCodeRpt(), sgMNFCodeTagRpt)       'product protection
   ' ilRet = gRptSPersonPop(RptSelRevEvt, lbcSelection(4))   'populate salespeople
    ilRet = gRptVehPop(RptSelRevEvt, lbcSelection(5), VEHSPORT + VEHNTR + ACTIVEVEH)
    

    gUnpackDate tgSpf.iBLastStdMnth(0), tgSpf.iBLastStdMnth(1), slStr
    calEnd.Text = Trim$(slStr)
    'get std month start date
    slStr1 = gObtainStartStd(slStr)
    calStart.Text = Trim$(slStr1)
...
Private Sub mParseCmmdLine()
    ...
    'End If
    'gInitStdAlone RptSelRevEvt, slStr, ilTestSystem
...
'
    ...
    If lbcSelection(0).Visible = True Then          'advertiser list
        If lbcSelection(0).SelCount <= 0 Then
            ilEnable = False
        End If
    End If
    
    If lbcSelection(5).Visible = True Then          'vehicle list
        If lbcSelection(5).SelCount <= 0 Then
            ilEnable = False
        End If
    End If
       
    If smCalStart = "" Or smCalEnd = "" Then
        ilEnable = False
    End If
...
Private Sub plcAirTimeNTR_Paint()
    plcAirTimeNTR.Cls
    plcAirTimeNTR.CurrentX = 0
    plcAirTimeNTR.CurrentY = 0
    plcAirTimeNTR.Print "Select"
End Sub
