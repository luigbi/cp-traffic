...
Begin VB.Form RptSelCp 
   ...
   Begin VB.Frame frcOption 
      ...
      Begin VB.PictureBox pbcOption 
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   2970
            Index           =   0
            ItemData        =   "Rptselcp.frx":0000
            Left            =   240
            List            =   "Rptselcp.frx":0002
   ...
   End
End
Attribute VB_Name = "RptSelCp"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of Rptselcp.frm on Wed 6/17/09 @ 12:56 P
...
'
' File Name: RptSelCp.Frm  - CPP/CPM by Demo
'
' Release: 1.0
'
' Description:
...
Private Sub cmcGen_Click()
    ...
    For ilJobs = ilStartJobNo To ilNoJobs Step 1
        ...
        If Not gOpenPrtJob("cppcpm.Rpt") Then
            igGenRpt = False
            ...
            Exit Sub
        End If
        ilRet = gCmcGenCp(imGenShiftKey, smLogUserCode)
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Erase tgCSVNameCode
    Erase tgRptSelDemoCodeCP
    Erase tgClfCP
    Erase tgCffCP
    Erase imCodes
    PECloseEngine
    
    Set RptSelCp = Nothing   'Remove data segment
...
'    edcSelCFrom.MaxLength = 10  '8  5/28/99 allow m/d/yyyy for input
...
Dim slStr As String
    ...
    RptSelCp.Caption = smSelectedRptName & " Report"
...
Private Sub mInitReport()
    ...
    ckcAll.Enabled = True
    ilRet = gPopMnfPlusFieldsBox(RptSelCp, lbcSelection(0), tgRptSelDemoCodeCP(), sgRptSelDemoCodeTagCP, "D")
    lbcSelection(0).Visible = True         'see demo list box
    ckcAll.Caption = "All Demos"
    ckcAll.Visible = True
'    mAskEffDate
'    lacSelCFrom1.Move 3000, lacSelCTo1.Top, 720
'    edcSelCFrom1.Move 3620, edcSelCTo1.Top, 300
'    plcSelC1.Move 120, edcSelCTo.Top + edcSelCTo.Height, 3000
    'plcSelC1.Caption = "Show"
'    plcSelC1.Visible = True
'    rbcSelCSelect(0).Caption = "CPP"
'    rbcSelCSelect(0).Move 660, 0, 680
'    rbcSelCSelect(0).Visible = True
'    rbcSelCSelect(1).Caption = "CPM"
'    rbcSelCSelect(1).Move 1360, 0, 680
'    rbcSelCSelect(1).Visible = True
'    rbcSelCSelect(0).Value = True
'    plcSelC2.Move 120, plcSelC1.Top + plcSelC1.Height, 3000
...
'    rbcSelCInclude(1).Visible = True
    ...
    Else
        rbcSelCInclude(1).Value = vbChecked
    End If
...
'    lacContract.Move 120, plcSelC2.Top + plcSelC2.Height + 30
'    lacContract.Visible = True
'    edcContract.Move 1290, plcSelC2.Top + plcSelC2.Height, 945
'    edcContract = ""
...
Private Sub mParseCmmdLine()
    ...
    'End If
    'gInitStdAlone RptSelCp, slStr, ilTestSystem
    ...
    '
    '    smSelectedRptName = "CPP/CPM by Demo"
...
'
    ...
    Dim ilLoop As Integer
    ilEnable = False
'    If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") And (edcSelCTo1.Text <> "") And (edcSelCFrom1.Text <> "") Then
    If (CSI_CalFrom.Text <> "") And (edcSelCTo.Text <> "") And (edcSelCTo1.Text <> "") And (edcSelCFrom1.Text <> "") Then       '12-13-19 use csi calendar control vs edit edit box
