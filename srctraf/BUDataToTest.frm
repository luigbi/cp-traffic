...
Begin VB.Form BUDataToTest 
   ...
   End
End
Attribute VB_Name = "BUDataToTest"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of BUDataToTest.frm on Wed 6/17/09 @ 12:
...
Private Sub cmcStart_Click()
    ...
    If Not mGetTestIniInfo Then
        gOpenBUMsgFile "Database is not properly defined under [TestLocations] in the Traffic.ini file."
        igBUerror = True
        Exit Sub
    End If

    If Not gContDBPathResolved Then
        gOpenBUMsgFile "ServerDatabase is not defined in Traffic.ini file." & Chr(10) & Chr(13) _
    ...
    ilRet = csiStartCopyDataToTest(sgDBPath, slTrafficINIPathName, 0)
    If ilRet <> 0 Then
...
Private Function mGetTestIniInfo() As Integer
    ...
    End If
    ilRet = GetPrivateProfileString("TestLocations", "Database", "Not Found", slReturn, 128, slFileName)
    If Left$(slReturn, ilRet) = "Not Found" Then
        'Don't let them backup live data to testdata
        MsgBox "Database is not properly defined under [TestLocations] in the Traffic.ini file."
