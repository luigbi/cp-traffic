...
Begin VB.Form RptSel 
   Appearance      =   0  'Flat
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Upfront Scatter Selection"
   ClientHeight    =   6075
   ClientLeft      =   585
   ClientTop       =   2775
   ClientWidth     =   10020
   ...
   Begin VB.Frame frcOption 
      ...
      Begin VB.PictureBox pbcSelC 
         ...
         Visible         =   0   'False
         Width           =   5085
         Begin VB.PictureBox plcShowTimes 
            BorderStyle     =   0  'None
            Height          =   255
            Left            =   120
            ScaleHeight     =   255
            ...
            Visible         =   0   'False
            Width           =   5055
            Begin VB.OptionButton optShowTimes 
               Caption         =   "Show Actual Times"
               Height          =   255
               Index           =   1
               Left            =   2040
               TabIndex        =   170
         ...
         Begin VB.PictureBox plcSelC9 
            ...
            Visible         =   0   'False
            Width           =   4380
            Begin VB.CheckBox ckcSuppressZB 
               Caption         =   "Suppress Zero Balance"
               BeginProperty Font 
                  Name            =   "Arial"
                  Size            =   8.25
                  Charset         =   0
         ...
         Begin VB.TextBox edcInvoice 
            ...
            Width           =   960
         End
         Begin VB.TextBox edcLatestCashDate 
            Appearance      =   0  'Flat
            BackColor       =   &H00FFFF00&
            BeginProperty Font 
               Name            =   "MS Sans Serif"
         ...
         Begin VB.PictureBox plcSelC4 
            ...
            Visible         =   0   'False
            Width           =   4275
            Begin VB.CheckBox ckcShowTimes 
               Caption         =   "Show Library Times"
               BeginProperty Font 
                  Name            =   "Arial"
                  Size            =   8.25
            ...
            End
         End
         Begin VB.Label lacWarning 
            Appearance      =   0  'Flat
            Caption         =   "Dates must be within same Mo-Sun week"
            ForeColor       =   &H00404040&
            Height          =   210
            Left            =   600
            TabIndex        =   162
         ...
         Begin VB.Label lacContract 
            ...
            Width           =   855
         End
         Begin VB.Label lacLatestCashDate 
            Appearance      =   0  'Flat
            Caption         =   "Latest Cash Date to Include"
            BeginProperty Font 
               Name            =   "Arial"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.PictureBox pbcSelA 
         ...
         Visible         =   0   'False
         Width           =   4845
         Begin V81TrafficReports.CSI_Calendar CSI_CalDateA 
            Height          =   255
            Left            =   1560
            TabIndex        =   164
            Top             =   0
      ...
      Begin VB.PictureBox pbcSelB 
         ...
         Visible         =   0   'False
         Width           =   4845
         Begin V81TrafficReports.CSI_Calendar CSI_CalAsOfDate 
            Height          =   255
            Left            =   1920
            TabIndex        =   163
            Top             =   1080
      ...
      Begin VB.PictureBox pbcOption 
         ...
         Begin VB.ListBox lbcSelection 
            ...
            Height          =   3390
            Index           =   12
            ItemData        =   "Rptsel.frx":0000
            Left            =   75
            List            =   "Rptsel.frx":0002
   ...
   End
End
Attribute VB_Name = "RptSel"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of Rptsel.frm on Wed 6/17/09 @ 12:56 PM
...
Dim imSetAllRC As Integer 'True=Set list box; False= don't change list box
Dim imAllRCClicked As Integer  'True=All box clicked (don't call ckcAll within lbcSelection)
...
Private Sub mSetConInvLocations(iIndex As Integer)
    If (iIndex = 1) Then
        lacContract.Move 120, 3730
        edcContract.Move edcContract.Left, 3700
        lacInvoice.Move lacInvoice.Left, 3730
        edcInvoice.Move edcInvoice.Left, 3700
    ElseIf (iIndex = 3) Then
        lacContract.Move 120, 3780
        edcContract.Move edcContract.Left, 3750
        lacInvoice.Move lacInvoice.Left, 3780
        edcInvoice.Move edcInvoice.Left, 3750
    Else
        lacContract.Move 120, 3495
        edcContract.Move edcContract.Left, 3465
        lacInvoice.Move lacInvoice.Left, 3495
        edcInvoice.Move edcInvoice.Left, 3465
    End If
End Sub
...
Private Sub mSellConvStdPkgPop(ilIndex As Integer, ilUselbcVehicle As Integer)
    ...
    If ilUselbcVehicle Then
        ilRet = gPopUserVehicleBox(RptSel, VEHCPMPKG + VEHSPORT + VEHREP_W_CLUSTER + VEHREP_WO_CLUSTER + VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHSTDPKG + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
    Else
        '12/1/21 - JW - TTP 10245 - Rate Card Report - Report is not pulling in Rep Vehicles information. (Added VEHCPMPKG + VEHSPORT + VEHREP_W_CLUSTER + VEHREP_WO_CLUSTER) to match RateCard screen
        ilRet = gPopUserVehicleBox(RptSel, VEHCPMPKG + VEHSPORT + VEHREP_W_CLUSTER + VEHREP_WO_CLUSTER + VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHSTDPKG + ACTIVEVEH, lbcSelection(ilIndex), tgCSVNameCode(), sgCSVNameCodeTag)   'lbcCSVNameCode)
    End If
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSellConvStdPkgPopErr
        gCPErrorMsg ilRet, "mSellConvStdPkgPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
...
Private Sub cbcSet1_Click()
    ...
    Else
        ...
        If ilSetIndex > 0 Then
            ...
            'ilRet = gPopMnfPlusFieldsBox(RptSel, lbcSelection(7), tgSOCode(), smVehGp5CodeTag, "H" & Trim$(Str$(ilSetIndex)))
...
Private Sub ckcAll_Click()
    ...
    If imSetAll Then
        imAllClicked = True
        If igRptCallType = RATECARDSJOB Or igRptCallType = CHFCONVMENU Or igRptCallType = POSTLOGSJOB Or igRptCallType = CMMLCHG Then     '3-28-19 condense tests
...
'        ElseIf igRptCallType = CHFCONVMENU Then            '3-28-19 move to common test above
'            If lbcSelection(0).ListCount > 0 Then
'                llRg = CLng(lbcSelection(0).ListCount - 1) * &H10000 Or 0
'                llRet = SendMessageByNum(lbcSelection(0).hWnd, LB_SELITEMRANGE, ilValue, llRg)
'            End If
        ...
        ElseIf igRptCallType = COPYJOB Then
            ...
            If ilIndex = 1 Then             'copy status by advt
                ...
                lbcSelection(5).Visible = False
            End If
'        ElseIf igRptCallType = POSTLOGSJOB Then        '3-28-19 move to common test above
'            llRg = CLng(lbcSelection(0).ListCount - 1) * &H10000 Or 0
'            llRet = SendMessageByNum(lbcSelection(0).hWnd, LB_SELITEMRANGE, ilValue, llRg)
        ...
        ElseIf igRptCallType = BULKCOPY Then
            ...
            llRg = CLng(lbcSelection(5).ListCount - 1) * &H10000 Or 0
            llRet = SendMessageByNum(lbcSelection(5).HWnd, LB_SELITEMRANGE, ilValue, llRg)
'        ElseIf igRptCallType = CMMLCHG Then                '3-28-19 move to common test above
'            llRg = CLng(lbcSelection(0).ListCount - 1) * &H10000 Or 0
'            llRet = SendMessageByNum(lbcSelection(0).hWnd, LB_SELITEMRANGE, ilValue, llRg)
        ...
        ElseIf igRptCallType = COLLECTIONSJOB Then
            ...
            ElseIf ilIndex = COLL_CASH Or ilIndex = COLL_SALESCOMM_COLL Then
                llRg = CLng(lbcSelection(5).ListCount - 1) * &H10000 Or 0
                llRet = SendMessageByNum(lbcSelection(5).HWnd, LB_SELITEMRANGE, ilValue, llRg)
        ...
        ElseIf (igRptCallType = USERLIST And ilIndex = USER_ACTIVITY) Then
            llRg = CLng(lbcSelection(10).ListCount - 1) * &H10000 Or 0
            llRet = SendMessageByNum(lbcSelection(10).HWnd, LB_SELITEMRANGE, ilValue, llRg)
        ElseIf igRptCallType = VEHICLESLIST Then
            If (ilIndex = 0 Or ilIndex = 5) Then
                llRg = CLng(lbcSelection(0).ListCount - 1) * &H10000 Or 0
                llRet = SendMessageByNum(lbcSelection(0).HWnd, LB_SELITEMRANGE, ilValue, llRg)
            ElseIf (ilIndex = LIST_STDPKG) Then
                llRg = CLng(lbcSelection(10).ListCount - 1) * &H10000 Or 0
                llRet = SendMessageByNum(lbcSelection(10).HWnd, LB_SELITEMRANGE, ilValue, llRg)
            Else
                llRg = CLng(lbcSelection(0).ListCount - 1) * &H10000 Or 0
            ...
            End If
        Else
            If (ilIndex = 1) Or (igRptCallType = EVENTNAMESLIST) Then
                llRg = CLng(lbcSelection(0).ListCount - 1) * &H10000 Or 0
                llRet = SendMessageByNum(lbcSelection(0).HWnd, LB_SELITEMRANGE, ilValue, llRg)
...
Private Sub ckcAllRC_Click()
    ...
    If imSetAllRC Then
        imAllRCClicked = True
        If igRptCallType = COLLECTIONSJOB And ilIndex = COLL_CASH Then
            If lbcSelection(8).ListCount > 0 Then       'select all vehicles
                llRg = CLng(lbcSelection(8).ListCount - 1) * &H10000 Or 0
                llRet = SendMessageByNum(lbcSelection(8).HWnd, LB_SELITEMRANGE, ilValue, llRg)
            End If
        End If
        imAllRCClicked = False
    End If
    mSetCommands
End Sub
...
'            edcSelA.Visible = True
            CSI_CalDateA.Move 2420, lacFromA.Top - 30           '8-28-19 use csi cal control vs edit box
            CSI_CalDateA.Visible = True
            lacFromA.Visible = True
        Else
            lacFromA.Visible = False
'            edcSelA.Visible = False
            CSI_CalDateA.Visible = False
        End If
    End If
    mSetCommands
End Sub
...
Private Sub ckcShowTimes_Click()
    'TTP 9944 - Program Library report
    If ckcShowTimes.Value = vbChecked Then
        lacWarning.Visible = True
        plcShowTimes.Visible = True
    Else
        lacWarning.Visible = False
        plcShowTimes.Visible = False
    End If
End Sub
...
'        End If
    ...
    If igRptCallType = COPYJOB And ilListIndex = 3 And rbcOutput(3).Value = True Then
        'We are exporting to file, not using crystal
    Else
    ...
    For ilJobs = ilStartJobNo To ilNoJobs Step 1
        ...
        If igRptCallType = BUDGETSJOB Or igRptCallType = RATECARDSJOB Or igRptCallType = NYFEED Or igRptCallType = DALLASFEED Or igRptCallType = PHOENIXFEED Or igRptCallType = VEHICLESLIST Or igRptCallType = AGENCIESLIST Or igRptCallType = ADVERTISERSLIST Or igRptCallType = USERLIST Then
            ilRet = gCmcGenMore(ilListIndex, imGenShiftKey, smLogUserCode)
        Else
            'TTP 10791 - Copy Rotations by Advertiser report: add special export option
            If igRptCallType = COPYJOB And ilListIndex = 3 And rbcOutput(3).Value = True Then
                'We are exporting to file, not using crystal
...
'        End If  'user wants to quit.
       ...
       '1 falls thru - successful crystal report
        If igRptCallType = BUDGETSJOB Then
            If ilListIndex = 1 Then         'budget comparisons, create temp file forCyrstal
        ...
        ElseIf igRptCallType = RATECARDSJOB Then
            If ilListIndex = 0 Then         'create Crystal file of rate card prices
                Screen.MousePointer = vbHourglass
                gCRRCGen
                cbcSel.Clear
                Screen.MousePointer = vbDefault
        ...
        ElseIf igRptCallType = POSTLOGSJOB Then
            If ilListIndex = 0 Then         'create Crystal file POST LOG
                Screen.MousePointer = vbHourglass
                gPlogRpt False
            ElseIf ilListIndex = 1 Then
                Screen.MousePointer = vbHourglass     'ISCI only
                gPlogRpt True
            ElseIf ilListIndex = PL_LIVELOG Then        '12-8-05 live log activity
                gGenLiveLogRpt
            ElseIf ilListIndex = PL_STATION_POSTING Then    '1-23-19 Station Posting Activity
                gGenStationPostingRpt
            End If
            cbcSel.Clear
            Screen.MousePointer = vbDefault
        ...
        ElseIf igRptCallType = COPYJOB Then
            If ilListIndex = 11 Or ilListIndex = 13 Or ilListIndex = 14 Then   'Play List
                Screen.MousePointer = vbHourglass
                gCRPlayListGen
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = 2 Then     '12-7-99 contracts missing copy
                Screen.MousePointer = vbHourglass
                gCopyCntrRpt
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = COPY_ROT Then      '10-3-05
                Screen.MousePointer = vbHourglass
                'TTP 10791 - Copy Rotations by Advertiser report: add special export option
                gGenCopyRotRpt (rbcOutput(3).Value)
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = COPY_SPLITROT Then     '1-30-09
                Screen.MousePointer = vbHourglass
                gGenSplitBlackOutRpt
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = COPY_INVBYSTARTDATE Or ilListIndex = COPY_INVBYEXPDATE Or ilListIndex = COPY_INVPRODUCER Then   '11-22-06
                Screen.MousePointer = vbHourglass
                ilRet = gGenCopyInv()
                If ilRet = False Then            'some I/O error occured
                    Exit Sub
                End If
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = COPY_BOOK Then      '9-27-05
                Screen.MousePointer = vbHourglass
                '8-22-19 use csi calendar control vs text box
'                slInputStartDate = RptSel!edcSelCFrom.Text
'                slInputEndDate = RptSel!edcSelCTo.Text
                slInputStartDate = RptSel!CSI_CalFrom.Text
                slInputEndDate = RptSel!CSI_CalTo.Text
                ...
                '10-26-06 make gGenODFDay a generalized rtn
                ilRet = gGenODFDay(RptSel, slInputStartDate, slInputEndDate, lbcSelection(2), lbcSort, tgAirNameCode(), "L", "C")
                'Dan M 09-01-09 manipulate rtf to have double spacing.
                gRTFModifyFromTable
                Screen.MousePointer = vbDefault
        ...
        ElseIf igRptCallType = INVOICESJOB Then
            If ilListIndex = INV_REGISTER Or ilListIndex = INV_DISTRIBUTE Or ilListIndex = INV_TAXREGISTER Then              'invoice/Tax registers
                Screen.MousePointer = vbHourglass
                'TTP 10118 -Billing Distribution Export to CSV
                gCRRvrGen (rbcOutput(3).Value)
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = INV_VIEWEXPORT Then
                Screen.MousePointer = vbHourglass
                gDumpFileRpt 0, 0, "Invoice Export"     '4-13-05
                Screen.MousePointer = vbDefault
            ...
            ElseIf ilListIndex = INV_RECONCILE Then         '11-30-07
                Screen.MousePointer = vbHourglass
                gGenInstallmentReconcile
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = INV_UNPOSTED_STATIONS Then     '8-12-15
                Screen.MousePointer = vbHourglass
                gGenUnpostedBarterStations
                Screen.MousePointer = vbDefault
            End If
            
        ElseIf igRptCallType = COLLECTIONSJOB Then
            If ilListIndex = COLL_DISTRIBUTE Or ilListIndex = COLL_ACCTHIST Then
                Screen.MousePointer = vbHourglass
            ...
            ElseIf ilListIndex = COLL_AGEOWNER Or ilListIndex = COLL_AGESS Or ilListIndex = COLL_AGEPRODUCER Or ilListIndex = COLL_AGEPAYEE Or ilListIndex = COLL_AGEVEHICLE Or ilListIndex = COLL_AGESLSP Or ilListIndex = COLL_AGEMONTH Then
                ...
                gCRRvrGen (rbcOutput(3).Value)
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = COLL_CASHSUM Or ilListIndex = COLL_CASH Or ilListIndex = COLL_PAYHISTORY Or ilListIndex = COLL_SALESCOMM_COLL Then      '1-24-18 add Sales comm on collections
                Screen.MousePointer = vbHourglass
                gCashGen (ilListIndex)
                Screen.MousePointer = vbDefault
        ...
        ElseIf igRptCallType = PROGRAMMINGJOB Then
            If igRptType = 3 Then           'reports (vs links)
                ...
                End If
            Else            'link reports
                If (ilListIndex = 0 Or ilListIndex = 1) And (ckcInclCommentsA.Value = vbChecked) Then
                    Screen.MousePointer = vbHourglass
                    gCreateLinksWithAvailLen
                    Screen.MousePointer = vbDefault
        ...
        ElseIf igRptCallType = NYFEED Then
            If ilListIndex = 0 Then
                Screen.MousePointer = vbHourglass
                gDumpFileRpt 0, 0, "Engineering Feed"
                cbcSel.Clear
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = 1 Then
                Screen.MousePointer = vbHourglass
                gDumpFileRpt 0, 2, "Engineering Error Log"
                cbcSel.Clear
                Screen.MousePointer = vbDefault
            End If
        ...
        ElseIf igRptCallType = BULKCOPY Then
            If ilListIndex = 0 Then
                Screen.MousePointer = vbHourglass
                gListFileRpt ilListIndex, "Bulk Feed"
                cbcSel.Clear
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = 1 Then
                Screen.MousePointer = vbHourglass
                gListFileRpt ilListIndex, "Bulk Copy Cross Reference"
                cbcSel.Clear
                Screen.MousePointer = vbDefault
            End If
        ...
        ElseIf igRptCallType = CMMLCHG Then
            If ilListIndex = 0 Then
                Screen.MousePointer = vbHourglass
                gListFileRpt ilListIndex, "Commercial Change Export"
                cbcSel.Clear
                Screen.MousePointer = vbDefault
            End If
        ...
        ElseIf igRptCallType = EXPORTAFFSPOTS Then
            If ilListIndex = 0 Then
                Screen.MousePointer = vbHourglass
                gDumpFileRpt 0, ilListIndex, "Affiliate Export"
                cbcSel.Clear
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = 1 Then
                Screen.MousePointer = vbHourglass
                gDumpFileRpt 0, 2, "Affiliate Error Log"
                cbcSel.Clear
                Screen.MousePointer = vbDefault
            End If
            
        ElseIf igRptCallType = AGENCIESLIST And ilListIndex = 2 Then        '10-13-03 mailing labels
            Screen.MousePointer = vbHourglass
            gGenMailLabels
            Screen.MousePointer = vbDefault
        ...
        ElseIf igRptCallType = USERLIST Then            '9-28-09
            ...
            ElseIf ilListIndex = USER_ACTIVITY Then         '5-9-11
                ...
                gGenUserActivity
                Screen.MousePointer = vbDefault
            ElseIf ilListIndex = USER_SUMMARY Then         '5-9-11
                Screen.MousePointer = vbHourglass
                gGenUserSummary
                Screen.MousePointer = vbDefault
            End If
            
        ElseIf igRptCallType = VEHICLESLIST Then          '9-30-15
    ...
    '                End If
                ...
                'TTP 10117 - Reports: Cash Distribution report - add export option to export to CSV
                'TTP 10164 - also handy for Ageing summary by month - export option for Audacy A/R dump
                ElseIf rbcOutput(3).Value Then
                    MsgBox "export complete"
                End If
    ...
    imGenShiftKey = 0
    If (igRptCallType = BUDGETSJOB) Then
        If (ilListIndex = 1) Then     'Budget Comparisons
            Screen.MousePointer = vbHourglass
            gCRGrfClear
            Screen.MousePointer = vbDefault
        End If
    ElseIf (igRptCallType = POSTLOGSJOB) Then
        If (ilListIndex = 0) Then     'Post Log Status and Missing ISCI
            Screen.MousePointer = vbHourglass
            gCRPlayListClear
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = PL_LIVELOG Or ilListIndex = PL_STATION_POSTING Then        '1-23-19
            gCRGrfClear
        End If
    ElseIf (igRptCallType = RATECARDSJOB) Then
        If (ilListIndex = 0) Then     'Rate Cards Flights
            Screen.MousePointer = vbHourglass
            gCRGrfClear
            Screen.MousePointer = vbDefault
        End If
    ElseIf (igRptCallType = COPYJOB) Then
        If ilListIndex = 11 Or ilListIndex = 13 Or ilListIndex = 14 Or ilListIndex = 2 Then     '12-7-99 Contracts Missing copy or Play List
            Screen.MousePointer = vbHourglass
            gCRPlayListClear
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = COPY_ROT Then      '2-2-15 clear the subreport for vehicle names
            gCRPlayListClear
            gClearTxr
        ...
        ElseIf ilListIndex = COPY_INVBYSTARTDATE Or ilListIndex = COPY_INVBYEXPDATE Or ilListIndex = COPY_INVPRODUCER Then       '4-10-13
            gCRPlayListClear                    'clear cpr temporary table
        ...
        '4-12-05 Set printables on Inventory by Entry date
        If ilListIndex = 10 Then
            If RptSel!ckcSelC5(0).Value = vbChecked Then
                mSetPrintForEntryDate
            End If
        End If

        If ilListIndex = 0 Or ilListIndex = 1 Then  'Copy Status by Date & Copy Status by Adv
            Screen.MousePointer = vbHourglass
            gCRPlayListClear
            Screen.MousePointer = vbDefault
        End If
    ...
    ElseIf (igRptCallType = INVOICESJOB) Then
        If ilListIndex = INV_REGISTER Or ilListIndex = INV_DISTRIBUTE Or ilListIndex = INV_CREDITMEMO Or ilListIndex = INV_SUMMARY Or ilListIndex = INV_TAXREGISTER Then
            Screen.MousePointer = vbHourglass
            gRvrClear
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = INV_VIEWEXPORT Then
            ...
            gClearTxr
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = INV_RECONCILE Then
            Screen.MousePointer = vbHourglass
            gCRGrfClear
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = INV_UNPOSTED_STATIONS Then     '8-12-15
        ...
        End If
    ElseIf (igRptCallType = COLLECTIONSJOB) Then
        If ilListIndex = COLL_PAYHISTORY Or ilListIndex = COLL_CASH Or ilListIndex = COLL_DISTRIBUTE Or ilListIndex = COLL_ACCTHIST Or ilListIndex = COLL_CASHSUM Or ilListIndex = COLL_POAPPLY Or ilListIndex = COLL_STATEMENT Or ilListIndex = COLL_SALESCOMM_COLL Then
            Screen.MousePointer = vbHourglass
            gRvrClear
            If ilListIndex = COLL_ACCTHIST Then     '10-13-15 these records are the decrypted user names associated with the transactions
                gClearTxr
            End If
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = COLL_AGEOWNER Or ilListIndex = COLL_AGESS Or ilListIndex = COLL_AGEPRODUCER Or ilListIndex = COLL_AGEPAYEE Or ilListIndex = COLL_AGEVEHICLE Or ilListIndex = COLL_AGESLSP Or ilListIndex = COLL_AGEMONTH Then
            ...
            gRvrClear
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = COLL_MERCHANT Or ilListIndex = COLL_MERCHRECAP Then
            Screen.MousePointer = vbHourglass
            gCRGrfClear
            Screen.MousePointer = vbDefault
        'TTP 9893
        ElseIf ilListIndex = COLL_CREDITSTATUS Then
            Screen.MousePointer = vbHourglass
            gCRGrfClear
            Screen.MousePointer = vbDefault
        End If
    ElseIf igRptCallType = PROGRAMMINGJOB Then
        If igRptType = 3 Then           'reports (vs links)
            If lbcRptType.ListIndex = 0 Then        'program library
                gCRGrfClear
                gClearScr               'Date: 10/16/2018   delete SCR rows after displaying the report FYM
            End If
        Else            '7-25-14 link reports with Avail lengths
            If ((ilListIndex = 0 Or ilListIndex = 1) And (ckcInclCommentsA.Value = vbChecked)) Then
                gCRGrfClear
            ElseIf ilListIndex = PRG_AIRING_INV Then        '3-31-15
                gCrCbfClear
            End If
        End If
    ElseIf igRptCallType = DALLASFEED Or igRptCallType = PHOENIXFEED Or igRptCallType = EXPORTAFFSPOTS Then
        'If ilListIndex = 1 Then
            Screen.MousePointer = vbHourglass
            gClearTxr
            Screen.MousePointer = vbDefault
    ...
    ElseIf igRptCallType = BULKCOPY Then
        If ilListIndex = 0 Or ilListIndex = 1 Then
            ...
            Screen.MousePointer = vbDefault
        End If
    ElseIf igRptCallType = AGENCIESLIST And ilListIndex = 2 Then
        Screen.MousePointer = vbHourglass
        gIvrClear
        Screen.MousePointer = vbDefault
    ElseIf igRptCallType = USERLIST Then            '9-28-09
        If ilListIndex = USER_OPTIONS Or ilListIndex = USER_SUMMARY Then
            Screen.MousePointer = vbHourglass
            gClearUOR
            Screen.MousePointer = vbDefault
        ElseIf ilListIndex = USER_ACTIVITY Then     '5-9-11
...
'End Sub
Private Sub CSI_CalAsOfDate_GotFocus()
    gCtrlGotFocus CSI_CalAsOfDate
End Sub

Private Sub CSI_CalDateA_CalendarChanged()
    mSetCommands
End Sub

Private Sub CSI_CalDateA_GotFocus()
    gCtrlGotFocus CSI_CalDateA
End Sub
...
Private Sub edcInvoice_GotFocus()
    gCtrlGotFocus edcInvoice
End Sub

Private Sub edcLatestCashDate_GotFocus()
    gCtrlGotFocus edcLatestCashDate         '5-20-19
End Sub
    ...
    If igRptCallType = RATECARDSJOB Then
        If ilListIndex = 0 Then                 'rate card report
            ...
            If ilLen = 4 Then
                ...
                ilRet = gPopRateCardBox(RptSel, llDate, lbcSelection(11), tgRateCardCode(), smRCTag, -1)
...
Private Sub Form_Load()
    ...
    'Date: 9/5/2018 set locations for Contract / Invoice controls   FYM
    pbcSelC.Height = 4250 '4120
    mSetConInvLocations 0
...
'                        ckcSelC3(0).Value = vbUnchecked
'                        ckcSelC3(0).Visible = True
'                        plcSelC3.Move 120, 120
'                        plcSelC3.Visible = True
'                        lbcSelection(10).Height = 4300
...
'
'                        ckcTrans.Move 0, 0, 2880
'                        ckcTrans.Caption = "Include Commission Info"
    ...
    Case USERLIST           '9-28-09
        Select Case lbcRptType.ListIndex
            ...
            Case USER_ACTIVITY     '5-6-11 user activity log
                ...
                ckcAll.Visible = True
                ilRet = gPopAllUsers(RptSel, 0, lbcSelection(10), tgUserSortCode(), sgUserSortCodeTag)
            ...
            Case USER_SUMMARY     'Date: 4/15/2020 User Summary report
                frcOption.Enabled = True
                pbcSelC.Visible = True
                ckcSelC7.Move 0, 0, 2880
                ckcSelC7.Caption = "Use System type as Major sort"
                ckcSelC7.Value = vbUnchecked
                ckcSelC7.Visible = True
                plcSelC7.Move 120, 120
                plcSelC7.Visible = True
        
                plcSelC1.Move plcSelC7.Left, plcSelC7.Top + plcSelC7.Height + 10
                plcSelC1.Visible = True
                rbcSelCSelect(0).Caption = "Sign on Name"
                rbcSelCSelect(1).Caption = "City"
                rbcSelCSelect(0).Value = True
                smPlcSelC1P = "Sort by"
                rbcSelCSelect(0).Move 735, 0, 1500
                rbcSelCSelect(1).Move 2300, 0, 960
                plcSelC1.Visible = True
                ...
                plcSelC6.Move plcSelC1.Left, plcSelC1.Top + plcSelC1.Height + 10
                rbcSelC6(0).Caption = "Active"      'Active
                rbcSelC6(1).Caption = "Dormant"     'Dormant
                rbcSelC6(2).Caption = "Both"        'Both
    ...
    Case RATECARDSJOB
        ...
        Select Case lbcRptType.ListIndex
            Case RC_RCITEMS                  'rate card flights report
                ...
                'ilRet = gPopRateCardBox(RptSel, 0, lbcSelection(11), tgRateCardCode(), smRateCardTag, -1)
                'lbcSelection(11).Visible = True
                'ckcAllRC.Visible = True
                ...
                If ((Asc(tgSpf.sUsingFeatures2) And BARTER) = BARTER) Then
                   plcSelC6.Move 120, plcSelC4.Top + plcSelC4.Height + 30, 4000
                   rbcSelC6(0).Caption = "Avg R/C Price"
                   rbcSelC6(0).Move 600, 0, 1680
                   rbcSelC6(1).Caption = "Default Acq. Fee"
                   rbcSelC6(1).Move 2280, 0, 2620
                   rbcSelC6(0).Value = True
                   rbcSelC6(0).Visible = True
                   rbcSelC6(1).Visible = True
                   rbcSelC6(2).Visible = False
                   smPlcSelC6P = "Show"
                   plcSelC6.Visible = True
                Else
                    rbcSelC6(0).Value = True
    ...
    Case PROGRAMMINGJOB
        If igRptType = 3 Then           'reports (vs links)
            ...
            Case 0
                ...
                rbcSelC4(0).Value = True            '10-3-18 change default to active
                plcSelC4.Visible = True
                rbcSelC4(0).Visible = True
                rbcSelC4(1).Visible = True
                rbcSelC4(2).Visible = False
                
                'Date: 10/4/2018    option for SHOW PROGRAM START TIMES     FYM
                ckcShowTimes.Move 0, rbcSelC4(0).Top + rbcSelC4(0).Height + 20
                ckcShowTimes.Visible = True
...
'                    lacSelCFrom1.Visible = True
                ...
                '12-10-19 change from edit box to csi calendar control
                CSI_CalFrom.Move 1320, plcSelC4.Top + plcSelC4.Height
                CSI_CalTo.Move 1320, CSI_CalFrom.Top + CSI_CalFrom.Height + 30, CSI_CalFrom.Width
'                    edcSelCFrom1.MaxLength = 10     'xx/xx/xxxx
                CSI_CalFrom.Visible = True
                CSI_CalTo.Visible = True
                lacSelCFrom.Caption = "Dates - Start"
                lacSelCFrom1.Caption = "End"
                lacSelCFrom.Move 120, CSI_CalFrom.Top + 30, 1560
                lacSelCFrom1.Move 780, CSI_CalTo.Top + 30, 480
                lacSelCFrom.Visible = True
                lacSelCFrom1.Visible = True

                'TTP 9944 - Program Library report - show times option
                plcShowTimes.Move plcSelC4.Left, lacSelCFrom1.Top + lacSelCFrom1.Height + 300
                
                'Date: 10/4/2018 warning label to make sure start/end dates are restricted to 1 week
                lacWarning.Move plcSelC4.Left, lacSelCFrom1.Top + lacSelCFrom1.Height + 300 + plcShowTimes.Height
                pbcSelC.Visible = True
        ...
        Else                        'links
            Select Case lbcRptType.ListIndex
                Case PRG_SELLTOAIR  '0  'selling vehicles
                    ckcAll.Caption = "All Vehicles"
                    edcSelA.Visible = False             '12-11-19 change to use csi calendar control
                    CSI_CalDateA.Visible = True
                ...
                Case PRG_VEHAVAILCONFLICT       '2  'Conflict
                    ckcAll.Caption = "All Vehicles"
                    edcSelA.Visible = False             '12-11-19 change to use csi calendar control
                    CSI_CalDateA.Visible = True
                    plcSel1.Visible = False
                    plcSel2.Move 120, CSI_CalDateA.Top + CSI_CalDateA.Height + 60     'move up to remove blank space between date and days
                ...
                Case PRG_DELIVERY_BYVEH, PRG_ENG_BYVEH    '3, 5  'Airing/Conventional Vehicles
                    ckcAll.Caption = "All Vehicles"
                    edcSelA.Visible = False             '12-11-19 change to use csi calendar control
                    CSI_CalDateA.Visible = True
                ...
                Case PRG_DELIVERY_BYFEED, PRG_ENG_BYFEED        '4, 6  'Feed
                ...
                Case PRG_AIRING_INV                     '3-31-15
                    ...
                    ilRet = gAvailsPop(RptSel, lbcSelection(5), tgNamedAvail())       'show the named avails for selectivity
...
'                edcSelCFrom.Visible = True
'                edcSelCFrom.Text = ""
            CSI_CalFrom.Move 2280, 120, 1140
            CSI_CalFrom.Visible = True
            CSI_CalFrom.Text = ""
...
'                edcSelCFrom1.Visible = True
'                edcSelCFrom1.Text = ""
            CSI_CalTo.Move 2280, CSI_CalFrom.Top + CSI_CalFrom.Height + 30, 1140
            CSI_CalTo.Visible = True
            CSI_CalTo.Text = ""
            
            lacSelCFrom1.Move 1680, CSI_CalFrom.Top + CSI_CalFrom.Height + 30
            lacSelCFrom1.Caption = "End"
            lacSelCFrom1.Visible = True
            ...
            lacSelCTo.Move 120, CSI_CalTo.Top + CSI_CalTo.Height + 30, 2040
            
'                edcSelCTo.Move 2280, lacSelCTo.Top, 1140
'                edcSelCTo.Visible = True
'                edcSelCTo.Text = ""
            CSI_CalFrom2.Move 2280, lacSelCTo.Top, 1140
...
'                edcSelCTo1.Visible = True
'                edcSelCTo1.Text = ""
            CSI_CalTo2.Move 2280, CSI_CalFrom2.Top + CSI_CalFrom2.Height + 30, 1140
            CSI_CalTo2.Visible = True
            CSI_CalTo2.Text = ""
            
            lacSelCTo1.Move 1740, CSI_CalFrom2.Top + CSI_CalFrom2.Height + 30
            lacSelCTo1.Caption = "End"
            lacSelCTo1.Visible = True
...
'                plcSelC5.Move 120, edcSelCTo1.Top + edcSelCTo1.Height
            plcSelC5.Move 120, CSI_CalTo2.Top + CSI_CalTo2.Height
            ...
            'tops are: 240,500,720,960 when all four Radio's are showing
            'tops are: 240,555,840 when three radios are showing
            rbcOutput(0).Top = 240
            rbcOutput(1).Top = 500
            rbcOutput(2).Top = 720
            rbcOutput(3).Top = 960
...
'                edcSelCTo.MaxLength = 10
            ...
            mAskDates False, False, "Active Rotations- "     '8-22-19 use csi calendar controls vs text box
...
'                        plcSelC5.Move 120, edcText2.Top + edcText2.Height + 30
                ...
                Else                    'by start date
                    ...
                    ilRet = gPopMCFBox(RptSel, lbcSelection(10), tgMcfCode(), sgMcfTagRpt)
                    ckcAll.Visible = True
        ...
        ElseIf ilListIndex = COPY_INVUNAPPROVED Then 'unapproved copy
            ...
            lacSelCFrom.Visible = False
            edcSelCFrom.Visible = False
            '8-23-19 change to use csi calendar control vs edit box
'                lacSelCTo.Width = 1800
            lacSelCTo.Move 120, 150, 1800
            lacSelCTo.Caption = "Received on or after"
            lacSelCTo.Visible = True
            edcSelCTo.Text = ""
'                edcSelCTo.Left = 1890
'                edcSelCTo.Visible = True
            CSI_CalTo.Move 2010, 120
            CSI_CalTo.Visible = True
            pbcSelC.Visible = True
            'lbcSelection(0).Move lbcSelection(0).Left, pbcSelC.Height + 60, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Height
            'lbcSelection(0).Visible = True
            ...
            'ckcAll.Visible = True
            pbcOption.Visible = False
        'copy regions merged into rptselsr (copy regions & split regions)
...
'                edcSelCTo.Visible = True
    ...
    Case POSTLOGSJOB
        ...
        If ilListIndex = 0 Then     'Post Log Status
            ...
            lacSelCTo.Visible = True
'               '8-20-19 change to csi calendar control vs text box
'                edcSelCFrom.Visible = True     'From Date   Tab 43
'                edcSelCFrom.Width = 1170
            CSI_CalFrom.Move 1320, lacSelCFrom.Top - 30
            CSI_CalFrom.Visible = True      '8-19-19 use csi calendar control vs edit box
            
'                edcSelCTo.Visible = True       'To Date     Tab 47
'                edcSelCTo.Width = 1170
            CSI_CalTo.Visible = True
            CSI_CalTo.Move CSI_CalFrom.Left, lacSelCTo.Top - 30
            CSI_CalFrom.CSI_AllowBlankDate = False
            CSI_CalTo.CSI_AllowBlankDate = False
            
            lacSelCTo1.Move 120, 780
            lacSelCTo1.Caption = "Contr #"
            lacSelCTo1.Visible = True

            edcSelCTo1.Move CSI_CalFrom.Left, 725, 1170
            ...
            plcSelC3.Move 120, edcSelCTo1.Top + edcSelCTo1.Height + 60, 4000, 480
'                plcSelC3.Left = 120
'                plcSelC3.Top = 1020
'                plcSelC3.Height = 480
...
'                edcSelCFrom.Visible = True     'From Date   Tab 43
'                edcSelCTo.Visible = True       'To Date     Tab 47
'                edcSelCTo.Width = edcSelCFrom.Width
'                edcSelCTo.MaxLength = 10
            lacSelCTo.Caption = "To Date"
            lacSelCTo.Visible = True
'               '8-20-19 change to csi calendar control vs text box
...
'                edcSelCFrom.Text = Format(gNow, "m/d/yy")
            mSellConvVVPkgPop 0, True, False, True       'ignore dormant vehicles, barter only
            If imTerminate Then
                Exit Sub
            End If
            '8-19-19 use csi calendar control vs edit box
            lacSelCFrom.Caption = "Invoice- Start"
'                edcSelCFrom.Move 1800, 60, 960
'                edcSelCFrom.MaxLength = 10
            CSI_CalFrom.Move 1320, 60
            CSI_CalFrom.Visible = True
            CSI_CalFrom.CSI_AllowBlankDate = False
            lacSelCFrom1.Caption = "End"
            lacSelCFrom1.Move 2640, lacSelCFrom.Top, 360
'                edcSelCFrom1.Move 3360, edcSelCFrom.Top, 960
'                edcSelCFrom1.MaxLength = 10
            CSI_CalTo.Move 3120, CSI_CalFrom.Top
            CSI_CalTo.Visible = True
            CSI_CalTo.CSI_AllowBlankDate = False
           lacSelCFrom.Visible = True
'                edcSelCFrom.Visible = True
...
'                edcSelCTo.Visible = True
            ...
            lacSelCTo.Caption = "Log In- Start"
            lacSelCTo.Move 120, edcSelCFrom.Top + edcSelCFrom.Height + 120, 1680
'                edcSelCTo.Move 1800, lacSelCTo.Top - 30, edcSelCFrom.Width
'                edcSelCTo.MaxLength = 10
            CSI_CalFrom2.Move CSI_CalFrom.Left, lacSelCTo.Top - 30
            CSI_CalFrom2.Visible = True
            CSI_CalFrom2.CSI_AllowBlankDate = False
            lacSelCTo1.Caption = "End"
            lacSelCTo1.Move lacSelCFrom1.Left, lacSelCTo.Top, 360
'                edcSelCTo1.Move 3360, edcSelCTo.Top, edcSelCTo.Width
'                edcSelCTo1.MaxLength = 10
            CSI_CalTo2.Move CSI_CalTo.Left, CSI_CalFrom2.Top
            CSI_CalTo2.Visible = True
            CSI_CalTo2.CSI_AllowBlankDate = False
            lacSelCFrom1.Visible = True
            lacSelCTo1.Visible = True
'                edcSelCFrom1.Visible = True
'                edcSelCTo1.Visible = True
            ...
            'Major/Minor sort parameters
             lacCheck.Move 120, edcSelCTo1.Top + edcSelCTo1.Height + 180, 840
             lacCheck.Caption = "Sort #1"
             cbcSet1.Move 960, edcSelCTo1.Top + edcSelCTo1.Height + 150, 1300
             
             mFillStationPostSortList cbcSet1, 0, False     'default to sort by invoice date
                                   
             lacCheck.Visible = True
             cbcSet1.Visible = True
             
             lacSort.Move 120, cbcSet1.Top + cbcSet1.Height + 90, 840
             lacSort.Caption = "Sort #2"
             cbcSet2.Move 960, cbcSet1.Top + cbcSet1.Height + 60, 1300
             lacSort.Visible = True
             cbcSet2.Visible = True
             mFillStationPostSortList cbcSet2, 2, False

        
             plcSelC10.Move 2380, cbcSet1.Top, 1300, (cbcSet3.Top - cbcSet1.Top) + cbcSet3.Height + 30
             ckcSelC10(0).Caption = "Skip"
             ckcSelC10(0).Visible = True
             ckcSelC10(0).Move 240, 60, 1300
             ckcSelC10(1).Caption = "Skip"
             '  at this time, only allow page skip on major sort, default to no page skip on minor
...
'                 ckcSelC10(1).Move 240, cbcSet1.Height + 60, 1300
             ...
             ckcAll.Visible = True
             lbcSelection(0).Height = 4305
             lbcSelection(0).Left = ckcAll.Left
             lbcSelection(0).Visible = True
             lbcSelection(0).Enabled = True
             pbcOption.Visible = True
             pbcOption.Enabled = True
             frcOption.Enabled = True
        End If
...
'                        edcSelCFrom.Text = gIncOneDay(slStr)
                    CSI_CalFrom.Text = gIncOneDay(slStr)           '8-15-19
                Else
'                       edcSelCFrom.Text = ""
                    CSI_CalFrom.Text = ""                     '8-15-19
                End If
'                    edcSelCFrom.Visible = True
                CSI_CalFrom.Visible = True                         '8-15-19
                lacSelCTo.Visible = True
                gUnpackDate tgSpf.iRCRP(0), tgSpf.iRCRP(1), slStr
                If Trim$(slStr) <> "" Then
'                        edcSelCTo.Text = slStr
                    CSI_CalTo.Text = slStr                         '8-15-19
                Else
                    edcSelCTo.Text = ""
                End If
'                    edcSelCTo.Visible = True
                CSI_CalTo.Visible = True                           '8-15-19
'                    edcSelCFrom.Left = 960
                CSI_CalFrom.Left = 960
'                    lacSelCTo.Move edcSelCFrom.Left + edcSelCFrom.Width + 120, lacSelCFrom.Top
                lacSelCTo.Move CSI_CalFrom.Left + CSI_CalFrom.Width + 120, lacSelCFrom.Top
'                    edcSelCTo.Move lacSelCTo.Left + 840, edcSelCFrom.Top
                CSI_CalTo.Move lacSelCTo.Left + 840, CSI_CalFrom.Top
'                    plcSelC1.Top = edcSelCTo.Top + edcSelCTo.Height + 30
                plcSelC1.Top = CSI_CalTo.Top + CSI_CalTo.Height + 30
...
'                    mAskStartEndDates
                mAskStartEndDatesUseCSICal          '8-15-19 Use csi calendar control vs edit text box
                plcSelC3.Left = 120
                plcSelC3.Top = edcSelCFrom.Top + edcSelCFrom.Height + 60
...
'                    mAskStartEndDates
                mAskStartEndDatesUseCSICal          '8-15-19 Use csi calendar control vs edit text box
                mAskContract edcSelCFrom.Top + edcSelCFrom.Height + 30, 120
...
'                    lacSelCTo.Move edcSelCFrom.Left + edcSelCFrom.Width + 120, lacSelCFrom.Top, 480
'                    edcSelCTo.Move lacSelCTo.Left + 480, edcSelCFrom.Top, 1200
                mAskStartEndDatesUseCSICal

'                    plcSelC4.Move 120, edcSelCTo.Top + edcSelCTo.Height + 90
                plcSelC4.Move 120, CSI_CalFrom.Top + CSI_CalFrom.Height + 90
                plcSelC4.Visible = True
                smPlcSelC4P = "By"
                plcSelC4_Paint
                rbcSelC4(0).Move 420, 0, 840    'gross button,
                rbcSelC4(0).Caption = "Gross"
                rbcSelC4(1).Move 1380, 0, 660   'net button
                rbcSelC4(1).Caption = "Net"
                rbcSelC4(1).Value = True
                rbcSelC4(2).Visible = False
                
                'Discrep only, showing only those months that don't balance from installment to billed
                plcSelC5.Move 120, plcSelC4.Top + plcSelC4.Height + 60
                ...
                lacCheck.Caption = "Contract #"
                edcCheck.Text = ""
                lacCheck.Move 120, plcSelC5.Top + plcSelC5.Height + 60, 1200
                edcCheck.Move 1080, lacCheck.Top - 30, 960
                edcCheck.MaxLength = 9                '1-27-06
                lacCheck.Visible = True
                edcCheck.Visible = True
                pbcSelC.Visible = True
                pbcOption.Visible = True
                
            Case INV_UNPOSTED_STATIONS          '8-13-15
                'get the next standard bdcst billing dates
                gUnpackDate tgSpf.iBLastStdMnth(0), tgSpf.iBLastStdMnth(1), slStr
                ilValue = Asc(tgSaf(0).sFeatures3)
               
                If (ilValue And REQSTATIONPOSTING) = REQSTATIONPOSTING Then 'Require Station Posting Prior to Invoicing
                    'require station posting prior to invocing; default to next month to invoice
                    slStr = gIncOneDay(slStr)
                    slCode = gObtainEndStd(slStr)
                    gObtainYearMonthDayStr slCode, True, slYear, slMonth, slDay
                    edcSelCTo.Text = Trim$(slYear)
                    slMonth = gMonthName(slCode)
                    edcSelCFrom.MaxLength = 3           'Jan, ....dec
                    edcSelCFrom.Text = Trim$(slMonth)
                Else                    'station posting not required, may have already run invoicing;default to last inv month
                    slCode = gObtainEndStd(slStr)
                    gObtainYearMonthDayStr slCode, True, slYear, slMonth, slDay
                    edcSelCTo.Text = Trim$(slYear)
                    slMonth = gMonthName(slCode)
...
'                    slStr = gIncOneDay(slStr)
'                    slCode = gObtainEndStd(slStr)
'                    lacSelCFrom.Width = 4000
'                    lacSelCTo.Width = 4000
'                    lacSelCFrom.Caption = "Generating unposted barter stations  "
'                    lacSelCTo.Caption = "for Std Month " + Trim$(slStr) & " - " + Trim$(slCode)
                
                lacSelCFrom.Move 120, 60, 600
                edcSelCFrom.Move 800, 0, 480
                lacSelCTo.Move 1400, 60, 600
                edcSelCTo.Move 2000, edcSelCFrom.Top, 600
                edcSelCFrom.MaxLength = 3    'month in char or number (1-12)
                ...
                plcSelC5.Move 120, edcSelCTo.Top + edcSelCTo.Height + 60, 3840, 270
                ckcSelC5(0).Value = vbChecked
                ckcSelC5(0).Caption = "Check Hidden Lines for Unposted Vehicles"
...
'                edcSelCFrom.Width = 1170
            ...
            CSI_CalFrom.Visible = True      '1-6-20 change to use csi calendar control
...
Private Sub lbcSelection_Click(Index As Integer)
    ...
    If Not imAllClicked Then
        ...
        ElseIf igRptCallType = COLLECTIONSJOB Then
            If ilListIndex = COLL_AGEPAYEE Or ilListIndex = COLL_AGEVEHICLE Or ilListIndex = COLL_AGESLSP Or ilListIndex = COLL_AGEOWNER Or ilListIndex = COLL_CASH Or COLL_SALESCOMM_COLL Then
            ...
            ElseIf ilListIndex = COLL_CASHSUM Or ilListIndex = COLL_CASH Or ilListIndex = COLL_PAYHISTORY Or ilListIndex = COLL_POAPPLY Or ilListIndex = COLL_ACCTHIST Or COLL_SALESCOMM_COLL Then
                imSetAll = False
                ckcAll.Value = vbUnchecked  ' False
                imSetAll = True
            ElseIf ilListIndex = COLL_STATEMENT Then
    ...
    If Not imAllRCClicked Then
        If igRptCallType = COLLECTIONSJOB And ilListIndex = COLL_CASH Then
            imSetAllRC = False
            ckcAllRC.Value = vbUnchecked  ' False
            imSetAllRC = True
        End If
...
'
    ...
    'ilRet = gPopAdvtBox(RptSel, lbcSelection, Traffic!lbcAdvertiser)
    ilRet = gPopAdvtBox(RptSel, lbcSelection, tgAdvertiser(), sgAdvertiserTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mAdvtPopErr
        gCPErrorMsg ilRet, "mAdvtPop (gPopAdvtBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mAdvtPopErr:
...
'
    ...
    ilRet = gPopAgyBox(RptSel, lbcSelection, tgAgency(), sgAgencyTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mAgencyPopErr
        gCPErrorMsg ilRet, "mAgencyPop (gPopAgyBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mAgencyPopErr:
...
Private Sub mAirVehPop()
    Dim ilRet As Integer
    'ilRet = gPopUserVehicleBox(RptSel, VEHAIRING + ACTIVEVEH, lbcSelection(1), lbcAirNameCode)
    ilRet = gPopUserVehicleBox(RptSel, VEHAIRING + ACTIVEVEH, lbcSelection(1), tgAirNameCode(), sgAirNameCodeTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mAirVehPopErr
        gCPErrorMsg ilRet, "mAirVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mAirVehPopErr:
...
Private Sub mAllConvAirVehPop(ilIndex As Integer, ilUselbcVehicle As Integer, Optional blTestMerge As Boolean = False)
    Dim ilRet As Integer
    'ilRet = gPopUserVehicleBox(RptSel, 7, lbcSelection(0), Traffic!lbcVehicle)
    If Not blTestMerge Then
        If ilUselbcVehicle Then
            'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH, lbcSelection(ilIndex), Traffic!lbcVehicle)
            ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
        Else
            'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH, lbcSelection(ilIndex), lbcAirNameCode)
            ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH, lbcSelection(ilIndex), tgAirNameCode(), sgAirNameCodeTag)
        End If
    Else
        If ilUselbcVehicle Then
            'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH, lbcSelection(ilIndex), Traffic!lbcVehicle)
            ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH + VEHTESTLOGMERGE, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
        Else
            'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH, lbcSelection(ilIndex), lbcAirNameCode)
            ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + ACTIVEVEH + VEHTESTLOGMERGE, lbcSelection(ilIndex), tgAirNameCode(), sgAirNameCodeTag)
        End If
    End If
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mAllConvAirVehPopErr
        gCPErrorMsg ilRet, "mAllConvAirVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
...
Private Sub mAllVehExLogPop(ilIndex As Integer)
    Dim ilRet As Integer
    'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHAIRING + VEHVIRTUAL + ACTIVEVEH + DORMANTVEH, lbcSelection(ilIndex), Traffic!lbcVehicle)
    ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHAIRING + VEHVIRTUAL + ACTIVEVEH + DORMANTVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mAllVehExLogPopErr
        gCPErrorMsg ilRet, "mAllVehExLogPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mAllVehExLogPopErr:
...
Private Sub mAllVehPop()
    ...
    'ilRet = gPopUserVehicleBox(RptSel, &H7FFF, lbcSelection(0), Traffic!lbcVehicle)
    llVehicles = VEHALLTYPES + DORMANTVEH + ACTIVEVEH
    'llVehicles = &H7FFFFFFF And (Not VEHBYPASSWEGENER_OLA)
    ilRet = gPopUserVehicleBox(RptSel, llVehicles, lbcSelection(0), tgVehicle(), sgVehicleTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mAllVehPopErr
        gCPErrorMsg ilRet, "mAllVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mAllVehPopErr:
...
Private Sub mPartVehPop()
    ...
    If ilRet <> CP_MSG_NOPOPREQ Then
        ...
        gCPErrorMsg ilRet, "mPartVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mPartVehPopErr:
...
Private Sub mAskEntryDates()
    ...
    lacSelCTo.Caption = "End"
    lacSelCFrom.Visible = True
    lacSelCFrom.Width = 1640
    CSI_CalFrom.Move lacSelCFrom.Width, lacSelCFrom.Top - 30
    gUnpackDate tgSpf.iRPRP(0), tgSpf.iRPRP(1), slStr
    If Trim$(slStr) <> "" Then
'            edcSelCFrom.Text = gIncOneDay(slStr)
        CSI_CalFrom.Text = gIncOneDay(slStr)
    Else
        CSI_CalFrom.Text = ""
    End If
'        edcSelCFrom.Visible = True
...
'        edcSelCFrom.Left = 1680
    lacSelCTo.Move CSI_CalFrom.Left + edcSelCFrom.Width, lacSelCFrom.Top
'        edcSelCTo.Move lacSelCTo.Left + 480, edcSelCFrom.Top
    CSI_CalTo.Move CSI_CalFrom.Left + edcSelCFrom.Width + 480, CSI_CalFrom.Top
...
'***********************************************************************
'
'               mAskStartEndDatesUseCSICal - Ask STart Date,  End Date
'                                   using CSI Calendar control
'                                   Default dates to end of
'                                   previous reconciled and currnet
'                                   reconciling period
'***********************************************************************
Private Sub mAskStartEndDatesUseCSICal()
    Dim slStr As String
    ...
    End If
    CSI_CalTo.Visible = True
    CSI_CalFrom.Left = 1020
    lacSelCTo.Move CSI_CalFrom.Left + CSI_CalFrom.Width + 120, lacSelCFrom.Top
    CSI_CalTo.Move lacSelCTo.Left + 840, CSI_CalFrom.Top
    CSI_CalFrom.Width = 1080
    CSI_CalTo.Width = 1080
End Sub
...
'
    Dim ilRet As Integer
    'ilRet = gPopVehBudgetBox(RptSel, 0, 1, lbcSelection(4), lbcBudgetCode)
    ilRet = gPopVehBudgetBox(RptSel, 2, 0, 1, lbcSelection(4), tgRptSelBudgetCode(), sgRptSelBudgetCodeTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mBudgetPopErr
        gCPErrorMsg ilRet, "mBudgetPopErr (gPopVehBudgetBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mBudgetPopErr:
...
'
    ...
    For illoop = 0 To lbcSelection(0).ListCount - 1 Step 1
        If lbcSelection(0).Selected(illoop) Then
            ...
            'ilRet = gPopCntrBox(RptSel, ilCntrType, ilFilter, ilCurrent, 0, ilVehCode, lbcMultiCntr, lbcMultiCntrCode, True, False, False, False)
            ...
            'ilRet = gPopCntrForAASBox(RptSel, 0, ilAdfCode, slCntrStatus, slCntrType, ilCurrent, ilHOState, ilShow, lbcMultiCntr, lbcMultiCntrCode)
            ilRet = gPopCntrForAASBox(RptSel, 0, ilAdfCode, slCntrStatus, slCntrType, ilCurrent, ilHOState, ilShow, lbcSelection(4), tgMultiCntrCode(), sgMultiCntrCodeTag)
            If ilRet <> CP_MSG_NOPOPREQ Then
                On Error GoTo mCntrPopErr
                gCPErrorMsg ilRet, "mCntrPop (gPopCntrBox)", RptSel
                On Error GoTo 0
            End If
...
Private Sub mConvAirVehPop()
    Dim ilRet As Integer
    'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_W_FEED + VEHAIRING + ACTIVEVEH, lbcSelection(3), Traffic!lbcVehicle)
    ilRet = gPopUserVehicleBox(RptSel, VEHCONV_W_FEED + VEHAIRING + ACTIVEVEH, lbcSelection(3), tgVehicle(), sgVehicleTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mConvAirVehPopErr
        gCPErrorMsg ilRet, "mConvAirVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mConvAirVehPopErr:
...
'
    Dim ilRet As Integer
    'Repopulate if required- if sales source changed by another user while in this screen
    'ilRet = gPopEvtNmByTypeBox(RptSel, True, True, lbcSelection(0), lbcNameCode)
    ilRet = gPopEvtNmByTypeBox(RptSel, True, True, lbcSelection(0), tgRptSelNameCode(), sgRptSelNameCodeTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mEvtNmPopErr
        gCPErrorMsg ilRet, "mEvtNmPop (gPopEvtNmBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mEvtNmPopErr:
...
'
    Dim ilRet As Integer
    'Repopulate if required- if sales source changed by another user while in this screen
    'ilRet = gPopMnfPlusFieldsBox(RptSel, lbcCtrl, lbcNameCode, "NNS")
    ilRet = gPopMnfPlusFieldsBox(RptSel, lbcCtrl, tgRptSelNameCode(), sgRptSelNameCodeTag, "NNS")
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mFeedPopErr
        gCPErrorMsg ilRet, "mFeedPop (gPopMnfPlusFieldsBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mFeedPopErr:
...
Private Sub mInit()
    ...
    RptSel.Caption = smSelectedRptName & " Report"
...
'VB6**    ilDummy = LlSetOption(hdJob, LL_OPTION_ONLYONETABLE, Not ilMultiTable)
    ...
    CSI_CalFrom.Move 1500, 60          '8-15-19
    CSI_CalTo.Move 2715, 60            '8-15-19
    ...
    '8-28-19 change the width of the panel for selection on left side of screen
    pbcSelA.Move 90, 255, 5085, 3960        '8-15-19 90, 255, 4515, 3960
    pbcSelB.Move 90, 255, 5085, 3960        '8-15-19
    'pbcSelC.Move 90, 255, 4515, 4845       '8-15-19
    pbcSelC.Move 90, 255, 5085, 3960            '8-27-15 change height for more questions

    '3/30/13
    ilRet = gVffRead()
    pbcClickFocus.Left = -pbcClickFocus.Width

    gCenterStdAlone RptSel
End Sub
...
'    End If
    ...
    rbcOutput(1).Top = 555
    rbcOutput(2).Top = 840
    rbcOutput(3).Top = 960: rbcOutput(3).Visible = False
    ...
    Select Case igRptCallType
        Case USERLIST           '9-28-09
            lbcRptType.AddItem "User Options", USER_OPTIONS
            lbcRptType.AddItem "User Activity Log", USER_ACTIVITY       '5-6-11
            lbcRptType.AddItem "User Summary", USER_SUMMARY             'Date: 4/15/2020 User Summary Report

        Case VEHICLESLIST
'            If smSelectedRptName = "Vehicle Participant Information" Then
'                mPartVehPop
'            Else
'                mAllVehPop
'            End If
...
'                Exit Sub
'            End If
            lbcRptType.AddItem "Vehicle Summary", 0
            lbcRptType.AddItem "Vehicle Options", 1
            lbcRptType.AddItem "Virtual Vehicles", 2
            lbcRptType.AddItem "Vehicle Groups", 3
            lbcRptType.AddItem "Log Closing Schedules", 4      '12-13-02
            lbcRptType.AddItem "Vehicle Participant Information", 5      '10-22-07
            lbcRptType.AddItem "Standard Package Vehicles", LIST_STDPKG         '9-30-15
            ckcAll.Caption = "All Vehicles"
            
        Case ADVERTISERSLIST
            'rptsel.Caption = "Advertiser Report Selection"
            mAdvtPop lbcSelection(0)
            If imTerminate Then
                Exit Sub
            End If
            lbcRptType.AddItem "Advertiser List", 0
            lbcRptType.AddItem "Advertiser Detail", 1
            'lbcRptType.ListIndex = igRptType
            'rbcRptType(0).Caption = "Advertiser Summary"
            'rbcRptType(1).Caption = "Advertiser Credit"
            'rbcRptType(2).Visible = False
            'rbcRptType(igRptType).Value = True
            'frcOption.Caption = "Advertiser Selection"
            ckcAll.Caption = "All Advertisers"
            For illoop = Asc("0") To Asc("Z") Step 1
                cbcFrom.AddItem Chr$(illoop)
                cbcTo.AddItem Chr$(illoop)
            Next illoop
            cbcFrom.ListIndex = 0
            cbcTo.ListIndex = cbcTo.ListCount - 1
            'If igRptType = 0 Then
        ...
        Case AGENCIESLIST
            'rptsel.Caption = "Agency Report Selection"
            mAgencyPop lbcSelection(0)
            If imTerminate Then
                Exit Sub
            End If

            lbcRptType.AddItem "Agency List", 0     '9-20-10  changed from summary to List
            lbcRptType.AddItem "Agency Detail", 1       'N/A
            lbcRptType.AddItem "Mailing Labels", 2      '10-13-03
            'lbcRptType.ListIndex = igRptType
            'rbcRptType(0).Caption = "Agency Summary"
            'rbcRptType(1).Caption = "Agency Credit"
            'rbcRptType(2).Visible = False
            'rbcRptType(igRptType).Value = True
            'frcOption.Caption = "Agency Selection"
            ckcAll.Caption = "All Agencies"
            For illoop = Asc("0") To Asc("Z") Step 1
                cbcFrom.AddItem Chr$(illoop)
                cbcTo.AddItem Chr$(illoop)
        ...
        Case SALESPEOPLELIST
            'rptsel.Caption = "Salespeople Report Selection"
            mSSourcePop
            If imTerminate Then
                Exit Sub
            End If
            ...
            If imTerminate Then
                Exit Sub
            End If
            lbcRptType.AddItem "Salespeople Summary", 0
            'lbcRptType.AddItem "Salespeople Budgets", 1
            'lbcRptType.ListIndex = igRptType
            'rbcRptType(0).Caption = "Salespeople Summary"
            'rbcRptType(1).Caption = "Salespeople Budgets"
            ''rbcRptType(2).Caption = "Salespeople Combos"
            'rbcRptType(2).Visible = False
            'rbcRptType(igRptType).Value = True
            'frcOption.Caption = "Salespeople Selection"
            ckcAll.Caption = "All Salespeople"
            'If igRptType = 0 Then
            '    lbcSelection(0).Visible = False
            '    lbcSelection(1).Visible = True
        ...
        Case EVENTNAMESLIST
            'rptsel.Caption = "Event Name Report Selection"
            mEvtNmPop
            If imTerminate Then
                Exit Sub
            End If
            ...
            'rbcRptType(0).Visible = False
            'rbcRptType(1).Visible = False
            'rbcRptType(2).Visible = False
            lbcSelection(0).Visible = True
            'frcOption.Caption = "Event Selection"
            ckcAll.Caption = "All Events"
            frcOption.Enabled = True
            pbcOption.Visible = True
            
        Case RATECARDSJOB
            Screen.MousePointer = vbHourglass
            'rptsel.Caption = "Rate Card Report Selection"
            lbcRptType.AddItem "Rate Card", RC_RCITEMS      'rate card report by item
            lbcRptType.AddItem "Dayparts", RC_DAYPARTS
            'frcOption.Caption = "Rate Card Selection"
            'lbcRptType.ListIndex = 0                        'default to r/C rept

            mSellConvStdPkgPop 0, False                    'lbcselection(0), vehicles
            If imTerminate Then
                Exit Sub
            End If
            frcOption.Visible = True
            frcOption.Enabled = True
            pbcOption.Visible = True            'show list boxes
            frcOption.Visible = True
            frcOption.Enabled = True
            pbcOption.Visible = True            'show list boxes
        ...
        Case BUDGETSJOB
            Screen.MousePointer = vbHourglass
            'rptsel.Caption = "Budget Report Selection"
            lbcRptType.AddItem "Budgets", 0
            lbcRptType.AddItem "Budget Comparisons", 1
            'lbcRptType.ListIndex = 0                        'default to Budget report
            'frcOption.Caption = "Budget Selection"
            mSellConvVirtVehPop 0, False                    'lbcselection(0), vehicles
            If imTerminate Then
                Exit Sub
            End If
            ...
            For ilIndex = 0 To lbcSelection(4).ListCount - 1 Step 1
                ...
                lbcSelection(2).AddItem slStr               'lbcselection(2) = comparison budgets
            Next ilIndex
            mSalesOfficePop lbcSelection(1)                                'lbcselection(1), sales offices
            If imTerminate Then
                Exit Sub
            End If
            frcOption.Visible = True
        ...
        Case PROGRAMMINGJOB
            If igRptType = 3 Then          'coming from main program screen
                'rptsel.Caption = "Programming Report Selection"
                mAllVehExLogPop 0   'mAllVehPop
                If imTerminate Then
                    Exit Sub
                End If
                lbcRptType.AddItem "Program Libraries", 0
                'frcOption.Caption = "Programming Selection"
                ckcAll.Visible = True
                frcOption.Visible = True
            ...
            Else                        'coming from links
                'rptsel.Caption = "Link Report Selection"
                mSellVehPop 'lbcSelection(0), lbcSellNameCode
                If imTerminate Then
                    Exit Sub
                End If
                mAirVehPop  'lbcSelection(1), Traffic!Vehicle
                If imTerminate Then
                    Exit Sub
                End If
                mFeedPop lbcSelection(2)
                If imTerminate Then
                    Exit Sub
                End If
                mConvAirVehPop 'lbcSelection(3), Traffic!Vehicle
                If imTerminate Then
                    Exit Sub
                End If
                lbcRptType.AddItem "Selling to Airing Vehicles", 0
                lbcRptType.AddItem "Airing to Selling Vehicles", 1
                lbcRptType.AddItem "Vehicle Avail Conflicts", 2
                lbcRptType.AddItem "Delivery by Vehicle", 3
                lbcRptType.AddItem "Delivery by Feed", 4
                lbcRptType.AddItem "Engineering by Vehicle", 5
                lbcRptType.AddItem "Engineering by Feed", 6
                lbcRptType.AddItem "Airing Vehicle Inventory", PRG_AIRING_INV           '3-31-15
                'frcOption.Caption = "Programming Selection"
                'lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
                'lbcSelection(1).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
                'lbcSelection(2).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
                ...
                lbcSelection(2).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
                lbcSelection(3).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
                lacFromA.Caption = "Effective Date"
                lacFromA.Move 120, 30, 2000
                edcSelA.Text = Format$(gNow(), "m/d/yy")
                CSI_CalDateA.Text = Format$(gNow(), "m/d/yy")
                ckcSel2(0).Value = vbChecked    'True
                ckcSel2(1).Left = 680
                ckcSel2(2).Left = 1320
                CSI_CalDateA.Move edcSelA.Left, edcSelA.Top
                frcOption.Enabled = True
                edcSelA.Visible = True
                plcSel1.Visible = True
                plcSel2.Visible = True
        ...
        Case COLLECTIONSJOB
            ...
            If imTerminate Then
                Exit Sub
            End If
           ' mMnfPop "H", RptSel!lbcSelection(3), tgVehicle(), sgVehicleTag    'Traffic!lbcVehicle         'owners groups
            '5-22-02 only show the participants, not other vehicle groups
            ilRet = gPopMnfPlusFieldsBox(RptSel, lbcSelection(3), tgVehicle(), sgVehicleTag, "H1")
            ...
            ilRet = gPopMnfPlusFieldsBox(RptSel, RptSel!lbcSelection(9), tgMNFCodeRpt(), sgMNFCodeTagRpt, "S")
            ...
            lbcRptType.AddItem "Ageing Summary by Month", COLL_AGEMONTH         '8-21-15
            lbcRptType.AddItem "Participant Payables", COLL_PARTPAY
            lbcRptType.AddItem "Sales Commissions on Collections", COLL_SALESCOMM_COLL       '1-24-18
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "Collection Selection"
            frcOption.Enabled = True
            rbcSelCSelect(2).Visible = False
            ...
            'rbcSelCInclude(0).Value = True   'Cash
            pbcSelC.Visible = True
            'TTP 9893
            'pbcOption.Visible = False
            pbcOption.Visible = True
        ...
        Case COPYJOB
            'rptsel.Caption = "Copy Report Selection"
            mAdvtPop lbcSelection(0)    'Called to initialize Traffic!Advertiser required be mCntrPop
            If imTerminate Then
                Exit Sub
            End If
            mAllConvAirVehPop 2, False, True 'Play List (Selling without Log, Airing, Log)
            If imTerminate Then
                Exit Sub
            End If

            mAllConvAirSellPkgVehPop 6    '12-8-05
            'mSellConvVVPkgPop 6, True      'show the package vehicles too
            'If imTerminate Then
            '    Exit Sub
            'End If
            lbcRptType.AddItem "Copy Status by Date", 0
            lbcRptType.AddItem "Copy Status by Advertiser", 1
            lbcRptType.AddItem "Contracts Missing Copy", 2
            lbcRptType.AddItem "Copy Rotations by Advertiser", 3
            ilIndex = 4
            'If tgSpf.sUseCartNo <> "N" Then            '7-1-04
                lbcRptType.AddItem "Copy Inventory by Number", ilIndex
                ilIndex = ilIndex + 1
            'End If
            lbcRptType.AddItem "Copy Inventory by ISCI", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Inventory by Advertiser", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Inventory by Start Date", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Inventory by Expiration Date", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Inventory by Purge Date", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Inventory by Entry Date", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Play List by ISCI", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Unapproved Copy", ilIndex
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Play List by Vehicle", ilIndex             'added 6/19/98
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Play List by Advertiser", ilIndex          'added 9-2-99
            ilIndex = ilIndex + 1
            lbcRptType.AddItem "Copy Regions", ilIndex             'added 6/19/98
            ilIndex = ilIndex + 1                                  'added 8-30-05 copy book
            lbcRptType.AddItem "Copy Book", ilIndex
            ilIndex = ilIndex + 1                                  'added 8-30-05 copy book
            lbcRptType.AddItem "Split Copy/Blackout Rotation", ilIndex  '1-30-09
            'ilIndex = ilIndex + 1                                   '4-9-12 Script Affidavits for co-ops
            lbcRptType.AddItem "Script Affidavits", COPY_SCRIPTAFFS
            lbcRptType.AddItem "Copy Inventory Producer Status", COPY_INVPRODUCER           '4-10-13
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "Copy Selection"
            frcOption.Enabled = True
            'lbcSelection(0).Move 15, ckcAll.Height + 30, 15, 4380
            'lbcSelection(1).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
            lbcSelection(1).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(2).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(6).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            '6-10-13 set the list boxes to same starting location
            lbcSelection(3).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            ...
            lbcSelection(7).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(8).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(9).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(10).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            
        Case POSTLOGSJOB
            'rptsel.Caption = "Post Log Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Log Posting Status", 0
            lbcRptType.AddItem "Missing ISCI Codes", 1
            lbcRptType.AddItem "Live Log Activity", PL_LIVELOG      '12-8-05
            lbcRptType.AddItem "Station Posting Activity", PL_STATION_POSTING       '1-23-19
            'lbcRptType.AddItem "Spot Export", 1
            'lbcRptType.ListIndex = 0
            'rbcRptType(0).Caption = "Log Posting Status"
            'rbcRptType(1).Caption = "Spot Export"
            'rbcRptType(1).Enabled = False
            'rbcRptType(2).Visible = False
            'rbcRptType(3).Visible = False
            'rbcRptType(4).Visible = False
            'rbcRptType(0).Value = True
            'frcOption.Caption = "Post log Selection"
            mSellConvVirtVehPop 0, True
            If imTerminate Then
                Exit Sub
            End If
            'ckcAll.Visible = False
        ...
        Case INVOICESJOB
            'rptsel.Caption = "Invoicing Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Invoice Register", 0
            lbcRptType.AddItem "View Invoice Export", 1
            lbcRptType.AddItem "Billing Distribution", INV_DISTRIBUTE
            ...
            lbcRptType.AddItem "Tax Register", INV_TAXREGISTER
            lbcRptType.AddItem "Installment Reconciliation", INV_RECONCILE
            lbcRptType.AddItem "Unposted Barter Stations", INV_UNPOSTED_STATIONS
            mAdvtPop lbcSelection(5)
            If imTerminate Then
                Exit Sub
            End If
            mSalesOfficePop lbcSelection(4)
            'mSellConvVirtVehPop 6, False
            mSellConvVVPkgPop 6, False, False       '3/30/99  dont use dormant vehicles
            If imTerminate Then
                Exit Sub
            End If
            mAgencyPop lbcSelection(1)
            ...
            End If
            'vehicle groups
            'mMnfPop "H", RptSel!lbcSelection(3), tgVehicle(), sgVehicleTag    'Traffic!lbcVehicle
            '1-21-03 Show only participants, not all vehicles groups
            sgVehicleTag = ""
            ilRet = gPopMnfPlusFieldsBox(RptSel, lbcSelection(3), tgVehicle(), sgVehicleTag, "H1")

            mMnfPop "I", RptSel!lbcSelection(8), tgMnfCodeCT(), sgMNFCodeTagCT  'NTR Item Billing 9-16-02
            'Sales Source
            ilRet = gPopMnfPlusFieldsBox(RptSel, RptSel!lbcSelection(9), tgMNFCodeRpt(), sgMNFCodeTagRpt, "S")

            For illoop = 1 To 9         '3-28-19
                lbcSelection(illoop).Move 15, ckcAll.Height + 30, 4380, 3000     'advt
            Next illoop
            
'            lbcSelection(5).Move 15, ckcAll.Height + 30, 4380, 3000     'advt
'            lbcSelection(1).Move 15, ckcAll.Height + 30, 4380, 3000     'agy
'            lbcSelection(2).Move 15, ckcAll.Height + 30, 4380, 3000     'slsp
'            lbcSelection(6).Move 15, ckcAll.Height + 30, 4380, 3000     'veh
'            lbcSelection(3).Move 15, ckcAll.Height + 30, 4380, 3000     'owner
'            lbcSelection(4).Move 15, ckcAll.Height + 30, 4380, 3000     'office
'            lbcSelection(7).Move 15, ckcAll.Height + 30, 4380, 3000     '10-8-03agencies and direct adv
'            lbcSelection(8).Move 15, ckcAll.Height + 30, 4380, 3000     '9-16-02 NTR
'            lbcSelection(9).Move 15, ckcAll.Height + 30, 4380, 3000     '10-17-02 Sales Source
            frcOption.Enabled = True
            
        Case CHFCONVMENU
            'rptsel.Caption = "Contract Import Report Selection"
            mChfConvPop
            lbcRptType.Visible = False
            'For ilLoop = 0 To 4
                'rbcRptType(ilLoop).Visible = False
            'Next ilLoop
            'frcOption.Caption = "Import Selection"
            ckcAll.Caption = "All imports"
            lbcSelection(0).Visible = True
            frcOption.Enabled = True
            pbcOption.Visible = True
        ...
        Case GENERICBUTTON
            ...
            'rptsel.Caption = "Generic Report Selection"
            'frcRptType.Enabled = False
            lbcRptType.Visible = False
            'frcOption.Caption = "Generic Selection"
        ...
        Case DALLASFEED
            'rptsel.Caption = "Dallas Feed Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Dallas Feed", 0
            lbcRptType.AddItem "Dallas Studio Log", 1
            lbcRptType.AddItem "Dallas Error Log", 2
            mPopDallasFileNames
            lbcSelection(2).Clear
            lbcSelection(2).AddItem "ExpDall.Txt"
            lbcSelection(2).Selected(0) = True
            'lbcSelection(0).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            'lbcSelection(1).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
            lbcSelection(1).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "Dallas Selection"
            frcOption.Visible = True
            ckcAll.Visible = False
            plcSelC1.Visible = False
            plcSelC2.Visible = False
        ...
        Case NYFEED
            'rptsel.Caption = "New York Feed Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Engineering Feed", 0            'dormant 4-23-14
            lbcRptType.AddItem "Engineering Error Log", 1       'dormant 4-23-14
            lbcRptType.AddItem "Blackout Suppression", 2
            lbcRptType.AddItem "Blackout Replacement", 3
            mPopNYFileNames
            lbcSelection(2).Clear
            lbcSelection(2).AddItem "ExpNY.Txt"
            lbcSelection(2).Selected(0) = True
            'lbcSelection(0).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "New York Selection"
            frcOption.Visible = True
            ckcAll.Visible = False
            plcSelC1.Visible = False
            plcSelC2.Visible = False
        ...
        Case PHOENIXFEED
            'rptsel.Caption = "Phoenix Feed Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Phoenix Studio Log", 0
            lbcRptType.AddItem "Phoenix Error Log", 1
            mPopPhoenixFileNames
            lbcSelection(2).Clear
            lbcSelection(2).AddItem "ExpPhnx.Txt"
            lbcSelection(2).Selected(0) = True
            'lbcSelection(0).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "Phoenix Selection"
            frcOption.Visible = True
            ckcAll.Visible = False
            plcSelC1.Visible = False
            plcSelC2.Visible = False
        ...
        Case CMMLCHG
            'rptsel.Caption = "Commercial Change Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Commercial Change Export", 0
            'lbcRptType.AddItem "Commercial Change", 1
            mPopCmmlChgFileNames
            'lbcSelection(0).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "Commercial Change Selection"
            frcOption.Visible = True
            ckcAll.Visible = False
            plcSelC1.Visible = False
            plcSelC2.Visible = False
        ...
        Case EXPORTAFFSPOTS
            'rptsel.Caption = "Affiliate Spots Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Affiliate Spots Export", 0
            lbcRptType.AddItem "Affiliate Spots Error Log", 1
            mPopAffSpotsFileNames
            lbcSelection(2).Clear
            lbcSelection(2).AddItem "Aff_Spot.Txt"
            lbcSelection(2).Selected(0) = True
            'lbcSelection(0).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "Affiliate Spot Selection"
            frcOption.Visible = True
            ckcAll.Visible = False
            plcSelC1.Visible = False
            plcSelC2.Visible = False
        ...
        Case BULKCOPY
            'rptsel.Caption = "Bulk Copy Feed Report Selection"
            Screen.MousePointer = vbHourglass
            lbcRptType.AddItem "Bulk Copy Feed", 0
            lbcRptType.AddItem "Bulk Copy Cross Reference", 1
            lbcRptType.AddItem "Affiliate Bulk Feed by Cart", 2
            lbcRptType.AddItem "Affiliate Bulk Feed by Vehicle", 3
            lbcRptType.AddItem "Affiliate Bulk Feed by Date", 4
            lbcRptType.AddItem "Affiliate Bulk Feed by Advertiser", 5
            mPopBulkCopyFileNames
            mConvAirVehPop
            If imTerminate Then
                Exit Sub
            End If
            ...
            'lbcSelection(0).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            'lbcSelection(1).Move lbcSelection(0).Left, 90, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Top - 90
            'lbcSelection(3).Move lbcSelection(0).Left, pbcSelC.Height + 60, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Height
            'lbcSelection(5).Move lbcSelection(0).Left, pbcSelC.Height + 60, lbcSelection(0).Width, ckcAll.Top - pbcSelC.Height
            lbcSelection(0).Move 15, ckcAll.Height + 30, 4380, 3000
            lbcSelection(1).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(3).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            lbcSelection(5).Move lbcSelection(0).Left, lbcSelection(0).Top, lbcSelection(0).Width, lbcSelection(0).Height
            'lbcRptType.ListIndex = 0
            'frcOption.Caption = "Bulk Copy Selection"
            frcOption.Visible = True
            ckcAll.Visible = False
            plcSelC1.Visible = False
            plcSelC2.Visible = False
...
Private Sub mMnfPop(slType As String, lbcLocal As Control, tlSortCode() As SORTCODE, slSortCodeTag As String) 'lbcMster As Control)
    ...
    'ilRet = gIMoveListBox(RptSel, lbcLocal, lbcMster, "Mnf.Btr", gFieldOffset("Mnf", "MnfName"), 20, ilFilter(), slFilter(), ilOffset())
    ilRet = gIMoveListBox(RptSel, lbcLocal, tlSortCode(), slSortCodeTag, "Mnf.Btr", gFieldOffset("Mnf", "MnfName"), 20, ilfilter(), slFilter(), ilOffSet())
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mMnfPopErr
        gCPErrorMsg ilRet, "mMnfPop (gImoveListBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mMnfPopErr:
...
Private Sub mParseCmmdLine()
    ...
    'End If
    'gInitStdAlone RptSel, slStr, ilTestSystem
...
Private Sub mSalesOfficePop(lbcSelection As Control)
    Dim ilRet As Integer
    'ilRet = gPopOfficeSourceBox(RptSel, lbcSelection, lbcSOCode)
    ilRet = gPopOfficeSourceBox(RptSel, lbcSelection, tgSOCode(), sgSOCodeTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSalesOfficePopErr
        gCPErrorMsg ilRet, "mSalesOfficePop (gPopOfficeSourceBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mSalesOfficePopErr:
...
Private Sub mSellConvAirPop(ilIndex As Integer, ilUselbcVehicle As Integer)
    Dim ilRet As Integer
    If ilUselbcVehicle Then
        ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHAIRING + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
    Else
        ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHAIRING + ACTIVEVEH, lbcSelection(ilIndex), tgCSVNameCode(), sgCSVNameCodeTag)    'lbcCSVNameCode)
    End If
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSellConvAirPopErr
        gCPErrorMsg ilRet, "mSellConvAirPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mSellConvAirPopErr:
...
Private Sub mSellConvVirtVehPop(ilIndex As Integer, ilUselbcVehicle As Integer)
    Dim ilRet As Integer
    If ilUselbcVehicle Then
        'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + VEHVIRTUAL + ACTIVEVEH, lbcSelection(ilIndex), Traffic!lbcVehicle)
        'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + ACTIVEVEH, lbcSelection(ilIndex), Traffic!lbcVehicle)
        ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
    Else
        'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + ACTIVEVEH, lbcSelection(ilIndex), lbcCSVNameCode)    'lbcCSVNameCode)
        ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + ACTIVEVEH, lbcSelection(ilIndex), tgCSVNameCode(), sgCSVNameCodeTag)    'lbcCSVNameCode)
    End If
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSellConvVirtVehPopErr
        gCPErrorMsg ilRet, "mSellConvVirtVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
...
'               vehicles
'*******************************************************
Private Sub mSellConvVVPkgPop(ilIndex As Integer, ilUselbcVehicle As Integer, ilUseDormant As Integer, Optional blInsertionsOnly As Boolean = False)
    Dim ilRet As Integer
    If ilUselbcVehicle Then
        'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHLOG + VEHVIRTUAL + VEHPACKAGE + ACTIVEVEH, lbcSelection(ilIndex), Traffic!lbcVehicle)
        'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHPACKAGE + ACTIVEVEH, lbcSelection(ilIndex), Traffic!lbcVehicle)
        If ilUseDormant Then
            If blInsertionsOnly Then
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHREP_W_CLUSTER + VEHREP_WO_CLUSTER + VEHNTR + ACTIVEVEH + DORMANTVEH + VEHONINSERTION, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
            Else
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHPACKAGE + VEHREP_WO_CLUSTER + VEHREP_W_CLUSTER + VEHNTR + ACTIVEVEH + DORMANTVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
            End If
        Else
            If blInsertionsOnly Then
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHREP_W_CLUSTER + VEHREP_WO_CLUSTER + VEHNTR + ACTIVEVEH + VEHONINSERTION, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
            Else
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHPACKAGE + VEHREP_WO_CLUSTER + VEHREP_W_CLUSTER + VEHNTR + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
            End If
        End If
    Else
        'ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHPACKAGE + ACTIVEVEH, lbcSelection(ilIndex), lbcCSVNameCode)    'lbcCSVNameCode)
        If ilUseDormant Then
            If blInsertionsOnly Then
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHREP_W_CLUSTER + VEHREP_WO_CLUSTER + VEHNTR + ACTIVEVEH + DORMANTVEH + VEHONINSERTION, lbcSelection(ilIndex), tgCSVNameCode(), sgCSVNameCodeTag)
            Else
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHPACKAGE + VEHREP_WO_CLUSTER + VEHREP_W_CLUSTER + VEHNTR + ACTIVEVEH + DORMANTVEH, lbcSelection(ilIndex), tgCSVNameCode(), sgCSVNameCodeTag)
            End If
        Else
            If blInsertionsOnly Then
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHREP_W_CLUSTER + VEHREP_WO_CLUSTER + VEHNTR + ACTIVEVEH + VEHONINSERTION, lbcSelection(ilIndex), tgCSVNameCode(), sgCSVNameCodeTag)
            Else
                ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + VEHVIRTUAL + VEHPACKAGE + VEHREP_WO_CLUSTER + VEHREP_W_CLUSTER + VEHNTR + ACTIVEVEH, lbcSelection(ilIndex), tgCSVNameCode(), sgCSVNameCodeTag)   'lbcCSVNameCode)
            End If
        End If
    End If
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSellConvVVPkgPopErr
        gCPErrorMsg ilRet, "mSellConvVVPkgPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
...
Private Sub mSellVehPop()
    Dim ilRet As Integer
    'ilRet = gPopUserVehicleBox(RptSel, VEHSELLING + ACTIVEVEH, lbcSelection(0), lbcSellNameCode)
    ilRet = gPopUserVehicleBox(RptSel, VEHSELLING + ACTIVEVEH, lbcSelection(0), tgSellNameCode(), sgSellNameCodeTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSellVehPopErr
        gCPErrorMsg ilRet, "mSellVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mSellVehPopErr:
...
'
        ...
        If ilListIndex = 1 Then                     'comparisons option
            If (ilEnable) Then                      'vehicle or office selected, check on budget names
                ...
                For illoop = 0 To lbcSelection(2).ListCount - 1 Step 1
                    ...
                    End If
                Next illoop
                If edcSelCTo <> "" And RptSel!rbcSelCSelect(2).Value Then
                    ilEnable = False
                End If
            End If
        End If
    ElseIf igRptCallType = RATECARDSJOB Then
        If ilListIndex = RC_RCITEMS Then
            If edcSelCFrom <> "" Then   'Or (edcSelCTo <> "" And RptSel!rbcSelCInclude(2).Value) Then
                If (edcSelCTo = "" And RptSel!rbcSelCInclude(2).Value) Then
                    ilEnable = False
                Else
                    ilEnable = False
                    If ckcAll.Value = vbChecked Then                   ' check for the correct selection list box here
    ...
    ElseIf igRptCallType = USERLIST Then         '9-28-09
        ...
        ElseIf ilListIndex = USER_ACTIVITY Then         '5-6-11
            ...
            If lbcSelection(10).SelCount > 0 Then
                ilEnable = True
            End If
        ElseIf ilListIndex = USER_SUMMARY Then          'Date: 4/15/2020 User Summary report
            ilEnable = True
        End If
    ElseIf igRptCallType = PROGRAMMINGJOB Then
    ...
    ElseIf igRptCallType = POSTLOGSJOB Then
        ilEnable = False
        If ilListIndex <> PL_STATION_POSTING Then
            'Missing ISCI, Log Posting Status or Live Log Activity
...
'                If (edcSelCFrom.Text = "" Or edcSelCFrom1.Text = "" Or edcSelCTo.Text = "" Or edcSelCTo1.Text = "") Then
                If (CSI_CalFrom.Text = "" Or CSI_CalTo.Text = "" Or CSI_CalFrom2.Text = "" Or CSI_CalTo2.Text = "") Then
                    ilEnable = False
                End If
...
'            If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") Then
            If (CSI_CalFrom.Text <> "") And (CSI_CalTo.Text <> "") Then
                ...
                ElseIf ilListIndex = COPY_BOOK Then
                    ilIndex = 2
                Else
                    If RptSel!rbcSelCSelect(1).Value = True Then    'copy by isci
                        If edcSelCTo1.Text <> "" Then
                            ilIndex = 2
                        Else
                            ilEnable = False
                        End If
                    ElseIf RptSel!rbcSelCSelect(0).Value Then
                        ilIndex = 2
                    Else
                        ilIndex = 0
                    End If
...
'            If (edcSelCTo.Text <> "") Then
        ...
        'Inventory by  8 = Expiration Date; 9 =Purge Date; 10 Entry Date
        If (ilListIndex = COPY_INVBYEXPDATE) Or (ilListIndex = COPY_INVBYPURGE) Or (ilListIndex = COPY_INVBYENTRYDATE) Then
'            If (edcSelCTo.Text <> "") Then
             If (CSI_CalTo.Text <> "") Then
               ilEnable = True
            Else
        ...
        If ilListIndex = COPY_INVUNAPPROVED Then        'unapproved copy
            ilEnable = False
'           If (edcSelCTo.Text <> "") Then
           If (CSI_CalTo.Text <> "") Then
                ilEnable = True
...
'                If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") Then
            ...
            If rbcSelC4(1).Value Then               'sort by slsp
                ...
                Else
                    ...
                    Next illoop
                End If
                If Not rbcSelC6(0).Value Then       'not air time only, check for selection of ntr items
        ...
        ElseIf ilListIndex = COLL_CASHSUM Then
            If RptSel!rbcSelCSelect(0).Value = True Then  'sort by vehicle
                ilEnable = True
            Else
        ...
        ElseIf ilListIndex = COLL_PAYHISTORY Then
            ...
            For illoop = 0 To lbcSelection(ilIndex).ListCount - 1 Step 1
                ...
                End If
            Next illoop
        ElseIf ilListIndex = COLL_DELINQUENT Then  'Delinquent
'            If (edcSelCTo.Text <> "") Then
            If (CSI_CalTo.Text <> "") Then          '8-29-19 use csi calendar control vs edit box
                ilEnable = True
            Else
                ilEnable = False
            End If
...
'            If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") Then
            If (CSI_CalFrom.Text <> "") And (CSI_CalTo.Text <> "") Then         '8-28-19 csi calendar control vs edit box
                ilEnable = True
            ...
            rbcOutput(3).Top = 960
            'TTP 10117 - Reports: Cash Distribution report - add export option to export to CSV
            If rbcSelCSelect(2).Value = True Then
                rbcOutput(3).Visible = True
            Else
                rbcOutput(3).Visible = False
                If rbcOutput(3).Value = True Then rbcOutput(0).Value = True
            End If
...
'            If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") Then
            If (CSI_CalFrom.Text <> "") And (CSI_CalTo.Text <> "") Then         '8-15-19
                ilEnable = True
                If Not ckcAll.Value = vbChecked Then
                    ilEnable = False
...
'            If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") Then
            If (CSI_CalFrom.Text <> "") And (CSI_CalTo.Text <> "") Then         '8-15-19
                ilEnable = True
                If Not ckcAll.Value = vbChecked Then
                    ilEnable = gSetGenCommand(RptSel!lbcSelection(3))   '10-8-03
                End If
            End If
            ...
            rbcOutput(1).Top = 500
            rbcOutput(2).Top = 720
            rbcOutput(3).Top = 960: rbcOutput(3).Visible = True
            
        ElseIf ilListIndex = 1 Then
            ilEnable = gSetGenCommand(RptSel!lbcSelection(0))   '10-8-03
        ElseIf ilListIndex = INV_CREDITMEMO Then                '10-8-03
            ilEnable = gSetGenCommand(RptSel!lbcSelection(7))
        ElseIf ilListIndex = INV_SUMMARY Then                       '6-28-05
...
'            If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") Then
            If (CSI_CalFrom.Text <> "") And (CSI_CalTo.Text <> "") Then         '8-15-19
                ilEnable = True
                If Not ckcAll.Value = vbChecked Then
                    ilEnable = gSetGenCommand(RptSel!lbcSelection(6))   'at least 1 vehicle must be selected
                End If
            End If
...
'            If (edcSelCFrom.Text <> "") And (edcSelCTo.Text <> "") Then
            If (CSI_CalFrom.Text <> "") And (CSI_CalTo.Text <> "") Then     '8-15-19
                ilEnable = True
            End If
        ElseIf ilListIndex = INV_UNPOSTED_STATIONS Then         '8-13-15
            ilEnable = True
        End If
    
    Else
        'If (rbcRptType(1).Value) Or (rbcRptType(0).Value And (igRptCallType = SALESPEOPLELIST)) Or (igRptCallType = EVENTNAMESLIST) Then
        If (ilListIndex = 1) Or ((ilListIndex = 0) And (igRptCallType = SALESPEOPLELIST)) Or (igRptCallType = EVENTNAMESLIST) Or ((ilListIndex = 0 Or ilListIndex = 5 Or ilListIndex = LIST_STDPKG) And igRptCallType = VEHICLESLIST) Then
            ilEnable = False
            If (ilListIndex = 1) Or (igRptCallType = EVENTNAMESLIST) Or ((ilListIndex = 0 Or ilListIndex = 5) And igRptCallType = VEHICLESLIST) Then
                If lbcSelection(0).SelCount > 0 Then            'for vehicle list, test anything selected
                    ilEnable = True
                End If
            Else
                If (ilListIndex = LIST_STDPKG And igRptCallType = VEHICLESLIST) Then
                    If lbcSelection(10).SelCount > 0 Then            'at least 1 pkg vehicle selected
                        ilEnable = True
                    End If
                Else
                    If lbcSelection(0).SelCount > 0 Then
    ...
    If ilEnable Then
        ...
        ElseIf rbcOutput(2).Value Then  'Save As
            ...
            Else
                ilEnable = False
            End If
        ElseIf rbcOutput(3).Value Then  'Export
...
'
    Dim ilRet As Integer
    'Repopulate if required- if sales source changed by another user while in this screen
    'ilRet = gPopSalespersonBox(RptSel, 0, True, True, lbcSelection, Traffic!lbcSalesperson, igSlfFirstNameFirst)
    ilRet = gPopSalespersonBox(RptSel, 0, True, True, lbcSelection, tgSalesperson(), sgSalespersonTag, igSlfFirstNameFirst)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSPersonPopErr
        gCPErrorMsg ilRet, "mSPersonPop (gPopSalespersonBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mSPersonPopErr:
...
'
    Dim ilRet As Integer
    'Repopulate if required- if sales source changed by another user while in this screen
    'ilRet = gPopSSourceByGroupBox(RptSel, lbcSelection(1), lbcNameCode)
    ilRet = gPopSSourceByGroupBox(RptSel, lbcSelection(1), tgRptSelNameCode(), sgRptSelNameCodeTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSSourcePopErr
        gCPErrorMsg ilRet, "mSSourcePop (gPopSSourceByGroupBox)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mSSourcePopErr:
...
Private Sub rbcOutput_Click(Index As Integer)
    ...
    If rbcOutput(Index).Value Then
        Select Case Index
            Case 0  'Display
                If igRptCallType = COLLECTIONSJOB And lbcRptType.ListIndex = COLL_DISTRIBUTE Then
                    ckcTrans.Visible = rbcSelCSelect(2).Value
                End If
            Case 1  'Print
...
Private Sub rbcSelC4_click(Index As Integer)
    ...
    ElseIf igRptCallType = COLLECTIONSJOB Then
        If ilListIndex = COLL_CASH Then
            ...
            cbcSet1.Enabled = True              'disabled for the ageing period sort
            lacSort.Visible = False
            edcText1.Visible = False
            ...
            If Index = 0 Then
                ...
                ckcAllGroups.Visible = False
                lbcSelection(7).Visible = False
                lbcSelection(8).Visible = False     '11-7-19
                ckcAll.Visible = False
                ckcAllRC.Visible = False
                lbcSelection(5).Visible = False
            
                'Date: 9/5/2018 set locations for Contract / Invoice controls   FYM
                mSetConInvLocations Index
                
            ElseIf Index = 1 Then
                ckcAll.Visible = True
                ckcAll.Caption = "All Salespeople"
                ckcAll.Left = 0
                lbcSelection(5).Height = 1860
                'lbcSelection(7).Height = 1500
                lbcSelection(8).Height = 1500       '11-7-19
                ckcAllGroups.Caption = "All Sales Offices"
                ckcAllGroups.Move ckcAll.Left, lbcSelection(5).Top + lbcSelection(5).Height + 60, 2040
                ckcAllGroups.Visible = True
                '11-7-19 insert ntr selection
                lbcSelection(7).Move lbcSelection(5).Left, ckcAllGroups.Top + ckcAllGroups.Height + 60, 4365, 1500
                lbcSelection(7).Width = (lbcSelection(5).Width / 2) - 120
                lbcSelection(8).Move lbcSelection(7).Left + lbcSelection(7).Width + 240, lbcSelection(7).Top, lbcSelection(7).Width, 1500
                ckcAllRC.Move lbcSelection(8).Left, ckcAllGroups.Top, 1560
                ckcAllRC.Caption = "All NTR Types"
                ckcAllRC.Visible = True
                ...
                If Not rbcSelC6(0).Value Then
                    ckcAllRC.Enabled = True
                    lbcSelection(8).Enabled = True
                Else
                    ckcAllRC.Enabled = False
                    lbcSelection(8).Enabled = False
                End If
                   
                'Date: 9/5/2018 set locations for Contract / Invoice controls   FYM
                mSetConInvLocations Index
                
            ElseIf Index = 3 Then                       'sort by ageing period
                ...
                ckcAllRC.Visible = False
                lbcSelection(5).Visible = False
                cbcSet1.ListIndex = 1                   'default to participant sort, disable it
                lacSort.Caption = "Earliest Ageing MM/YY"
                lacSort.Move 120, plcSelC8.Top + plcSelC8.Height + 30, 2040
                edcText1.Move 2040, plcSelC8.Top + plcSelC8.Height, 840
                lacSort.Visible = True
                edcText1.Visible = True
...
Private Sub rbcSelC6_Click(Index As Integer)
    ...
    ElseIf igRptCallType = COLLECTIONSJOB Then
        If ilListIndex = COLL_CASH Then
            If rbcSelC4(1).Value Then           'slsp option, can select ntr types if ntr is requested
                If Not rbcSelC6(0).Value Then
                    ckcAllRC.Enabled = True
                    lbcSelection(8).Enabled = True
                Else
            ...
            'for any sort option (date, slsp, vehicle group, etc), ask to show NTR item type if NTR requested
            If Not rbcSelC6(0).Value Then           'not air time only
                ckcOption.Enabled = True
            Else            'air time only
                ckcOption.Value = vbUnchecked
        ...
        Select Case igRptCallType
            Case RATECARDSJOB
                If rbcSelCInclude(2).Value Then             'week option
                    ...
                    If ((Asc(tgSpf.sUsingFeatures2) And BARTER) = BARTER) Then
                       plcSelC6.Move 120, edcSelCTo.Top + edcSelCTo.Height + 30, 4000
                       rbcSelC6(0).Caption = "Avg R/C Price"
                       rbcSelC6(0).Move 600, 0, 1680
                       rbcSelC6(1).Caption = "Default Acq. Fee"
                       rbcSelC6(1).Move 2280, 0, 2620
                   ...
                   ' rbcSelC8(2).Value = True                            'Include both rceivables & History
                    ...
                    Select Case Index
                        ...
                        Case 1                              'advt
                            ...
                            gPopVehicleGroups RptSel!cbcSet1, tgVehicleSets1(), True
            ...
            Case COLLECTIONSJOB
                ...
                'ElseIf ilListIndex = COLL_DISTRIBUTE Then
                    If Index = 2 Then
                        ...
                        If rbcOutput(3).Value = False Then ckcTrans.Visible = True
                        ckcTrans.Value = vbUnchecked
                        rbcOutput(3).Visible = True
                    Else
                        lbcSelection(3).Visible = False
...
'    edcSelCFrom.Move 1680, 120, 1080
    CSI_CalFrom.Move 1900, 120, 1080
'    lacSelCFrom1.Move 2880, 160, 360    'date entered- end
    lacSelCFrom1.Move 1240, CSI_CalFrom.Top + CSI_CalFrom.Height + 60, 360
'    edcSelCFrom1.Move 3240, 120, 1080
    CSI_CalTo.Move 1900, CSI_CalFrom.Top + CSI_CalFrom.Height + 30

'    lacSelCTo.Move 30, edcSelCFrom.Top + edcSelCFrom.Height + 60, 1680    'tran date - start
    lacSelCTo.Move 30, CSI_CalTo.Top + CSI_CalFrom.Height + 60, 1680    'tran date - start
'    edcSelCTo.Move 1680, edcSelCFrom.Top + edcSelCFrom.Height + 30, 1080
    CSI_CalFrom2.Move 1900, CSI_CalTo.Top + CSI_CalTo.Height + 30
'    lacSelCTo1.Move 2880, lacSelCTo.Top, 360    'tran date - end
    lacSelCTo1.Move 1060, CSI_CalFrom2.Top + CSI_CalFrom2.Height - 30, 360
'    edcSelCTo1.Move 3240, edcSelCTo.Top, 1080
    CSI_CalTo2.Move 1900, CSI_CalFrom2.Top + CSI_CalFrom2.Height + 30
...
'    cbcSet1.Move 1680, edcSet1.Top - 45
    edcSet1.Move 30, CSI_CalTo2.Top + CSI_CalTo2.Height + 90
    cbcSet1.Move 1900, CSI_CalTo2.Top + CSI_CalTo2.Height + 60
...
Public Sub mAskShowComments(plcPicture As Control, ckcCheck As Control, ilTopLoc As Integer)
    plcPicture.Move 120, ilTopLoc, 3360, 500 '120, ilTopLoc, 3360
    smPlcSelC9P = "Show transaction comments"
    ckcCheck.Move 0, 0, 3360
    ckcSuppressZB.Move ckcCheck.Left, ckcCheck.Top + ckcCheck.Height + 10
    plcPicture.Visible = True
    ckcCheck.Visible = True
    ckcSuppressZB.Visible = True
End Sub
...
Public Sub mAskCreditMemo()
    ...
    lacSelCFrom.Caption = "Entered -Start"
    lacSelCFrom1.Caption = "End"
    lacSelCTo.Caption = "Invoice -Start"
    lacSelCTo1.Caption = "End"
'CSI_CalFrom = Date Entered START
'CSI_CalTo = Date Entered END
    lacSelCFrom.Move 30, 160, 1320      'date entered- start
'    edcSelCFrom.Move 1680, 120, 1080
    CSI_CalFrom.Move 1320, 120, 1080       '8-16-19 use csi calendar control vs edit box
    lacSelCFrom1.Move 2520, lacSelCFrom.Top, 360    'date entered- end
'    edcSelCFrom1.Move 3240, 120, 1080
    CSI_CalTo.Move 3000, 120, 1080

'CSI_CalFrom2 = Inv Date START
'CSI_CalTo2 = Inv Date END
    lacSelCTo.Move 30, edcSelCFrom.Top + edcSelCFrom.Height + 150, 1680    'tran date - start
'    edcSelCTo.Move 1680, edcSelCFrom.Top + edcSelCFrom.Height + 30, 1080
    CSI_CalFrom2.Move CSI_CalFrom.Left, CSI_CalFrom.Top + CSI_CalFrom.Height + 60, 1080
    lacSelCTo1.Move lacSelCFrom1.Left, lacSelCTo.Top, 360   'tran date - end
'    edcSelCTo1.Move 3240, edcSelCTo.Top, 1080
    CSI_CalTo2.Move CSI_CalTo.Left, CSI_CalFrom2.Top, 1080
'    edcSelCTo.MaxLength = 8
'    edcSelCTo1.MaxLength = 8
'    edcSelCFrom.MaxLength = 8
'    edcSelCFrom1.MaxLength = 8
'    plcSelC4.Move 30, edcSelCTo.Top + edcSelCTo.Height + 60
    plcSelC4.Move 30, CSI_CalFrom2.Top + CSI_CalFrom2.Height + 60
    rbcSelC4(0).Move 1320, 0, 840
    rbcSelC4(0).Caption = "Billing"
    rbcSelC4(0).Visible = True
    rbcSelC4(1).Move 2160, 0, 840
    rbcSelC4(1).Caption = "Airing"
    rbcSelC4(1).Visible = True
    rbcSelC4(0).Value = True    'default to billing vehicle
    rbcSelC4(2).Visible = False
    plcSelC4.Visible = True
    smPlcSelC4P = "Show Vehicle"
    
    plcSelC6.Move 30, plcSelC4.Top + plcSelC4.Height + 60
    rbcSelC6(0).Move 1320, 0, 840
    rbcSelC6(0).Caption = "Detail"
    rbcSelC6(0).Visible = True
    rbcSelC6(1).Move 2160, 0, 960
    rbcSelC6(1).Caption = "Vehicle"
    rbcSelC6(1).Visible = True
    rbcSelC6(0).Value = True    'default to billing vehicle
    rbcSelC6(2).Visible = False
    plcSelC6.Visible = True
    smPlcSelC6P = "Totals By"
    
    lacCheck.Caption = "Contract #"
    'lacCheck.Move 30, edcSelCTo.Top + edcSelCTo.Height + 60
    lacCheck.Move 30, plcSelC6.Top + plcSelC6.Height + 60
    'edcCheck.Move 1200, edcSelCTo.Top + edcSelCTo.Height + 30
    edcCheck.Move 1200, plcSelC6.Top + plcSelC6.Height + 30
    lacCheck.Visible = True
    edcCheck.Visible = True
    ckcAll.Caption = "All Agencies and Advertisers"
    lbcSelection(7).Visible = True
...
'    edcSelCTo.Visible = True
'    edcSelCTo1.Visible = True
    '8-16-19 use csi calendar controls instead of edit boxes
    CSI_CalFrom.Visible = True      'date entered -start
    CSI_CalTo.Visible = True        'date entered - end
    CSI_CalFrom2.Visible = True     'inv date - start
    CSI_CalTo2.Visible = True       'inv date - end
...
Public Sub mCollectionSelectivity()
    ...
    edcLatestCashDate.Width = 1170
    edcLatestCashDate.MaxLength = 10
    edcLatestCashDate.Visible = False
    lacLatestCashDate.Visible = False
...
'                edcSelCFrom.Text = gIncOneDay(slStr)
            ...
            End If
'            edcSelCFrom.Visible = True
            CSI_CalFrom.Move 1200, lacSelCFrom.Top - 30
            CSI_CalFrom.Visible = True
            lacSelCTo.Move CSI_CalFrom.Left + CSI_CalFrom.Width + 240, lacSelCFrom.Top, 600
            lacSelCTo.Caption = "End"
            lacSelCTo.Visible = True
          
'            edcSelCTo.Left = 1050
            CSI_CalTo.Move lacSelCTo.Left + lacSelCTo.Width, CSI_CalFrom.Top
            gUnpackDate tgSpf.iRCRP(0), tgSpf.iRCRP(1), slStr
            If Trim$(slStr) <> "" Then
                CSI_CalTo.Text = slStr
            Else
...
'            edcSelCTo.Visible = True
            CSI_CalTo.Visible = True
'            plcSelC1.Move lacSelCTo.Left, CSI_CalTo.Top + CSI_CalTo.Height
            plcSelC1.Move 120, CSI_CalTo.Top + CSI_CalTo.Height + 60
            smPlcSelC1P = "Select"
            ...
            End If
            mAskCashTrMercProm plcSelC1.Top + plcSelC1.Height, False               'dont show hard cost option
...
'            edcSelCTo1.Visible = True
            ...
            ElseIf ilListIndex = COLL_AGESLSP Then         'slsp
                ...
                ckcOption.Move plcSelC9.Left, plcSelC9.Top + plcSelC9.Height + 30, 2160
                ckcOption.Caption = "Salespeople Splits"
                If ((Asc(tgSpf.sUsingFeatures4) And TAXBYUSA) = TAXBYUSA) Or ((Asc(tgSpf.sUsingFeatures4) And TAXBYCANADA) = TAXBYCANADA) Then
                    ckcOption.Visible = False
                    ckcOption.Value = vbUnchecked
                Else
                    ckcOption.Visible = True
                End If
...
'                plcSelC3.Move 120, edcSet1.Top + edcSet1.Height, 3000
                ...
                plcSelC10.Move 120, plcSelC9.Top + plcSelC9.Height - 30 '60
...
'            edcSelCTo.Visible = False
            ...
            If slStr <> "" Then
'               edcSelCFrom.Text = slStr
               CSI_CalFrom.Text = slStr
            Else
'                edcSelCFrom.Text = Format$(gNow(), "m/d/yy")
                CSI_CalFrom.Text = Format$(gNow(), "m/d/yy")
            End If
'            edcSelCFrom.Left = 1950
'            edcSelCFrom.Visible = True
            CSI_CalFrom.Move 2160, lacSelCFrom.Top - 30
            CSI_CalFrom.Visible = True
...
'                edcSelCTo.Text = "" 'Format$(Now, "m/d/yy")
                CSI_CalTo.Text = "" 'Format$(Now, "m/d/yy")
           End If
'            edcSelCTo.Left = 1950
'            edcSelCTo.Visible = True
            CSI_CalTo.Move CSI_CalFrom.Left, lacSelCTo.Top - 30
...
'            edcSelCFrom.Visible = True
            CSI_CalFrom.Move 2640, lacSelCFrom.Top - 30
            CSI_CalFrom.Visible = True
...
'            edcSelCTo.Visible = True
        ...
        Case COLL_CASH  'Cash Receipts
            mSalesOfficePop lbcSelection(7)         'sales office for sales option
            mMnfPop "I", RptSel!lbcSelection(8), tgMnfCodeCT(), sgMNFCodeTagCT  'NTR Item Billing
...
'            edcSelCFrom.Visible = True
            CSI_CalFrom.Text = ""
            CSI_CalFrom.Move lacSelCFrom.Left + lacSelCFrom.Width + 240, lacSelCFrom.Top - 30
            CSI_CalFrom.Visible = True

'            lacSelCTo.Width = 360
            lacSelCTo.Caption = "To"
            lacSelCTo.Move CSI_CalFrom.Left + CSI_CalFrom.Width + 240, lacSelCFrom.Top, 360
            lacSelCTo.Visible = True
'            edcSelCTo.Text = ""
'
...
'            edcSelCTo.Visible = True
            ...
            CSI_CalTo.Text = ""
            CSI_CalTo.Visible = True
            CSI_CalTo.Move lacSelCTo.Left + lacSelCTo.Width + 120, CSI_CalFrom.Top
            ckcAll.Visible = False
            ...
            Else
                rbcSelC4(0).Value = True
            End If
            rbcSelC4(3).Move 720, 240, 1740
            rbcSelC4(0).Visible = True
            rbcSelC4(1).Visible = True
            rbcSelC4(2).Visible = True
            rbcSelC4(3).Visible = True
            plcSelC4.Visible = True
            plcSelC4.Height = 480
            ...
            ckcOption.Caption = "Item Types"
            ckcOption.Move 3000, plcSelC7.Top, 1340
            ckcOption.Enabled = False
            ckcOption.Visible = True
            ...
            'Date: 9/6/2018 added filter Contract and Invoice FYM
            lacContract.Visible = True
            lacInvoice.Visible = True
            edcContract.Visible = True
            edcInvoice.Visible = True
        
        Case COLL_SALESCOMM_COLL  'Sales Commission on Collections
            mSalesOfficePop lbcSelection(7)         'sales office for sales option
            
            'determine default dates.  Get the last date invoiced (std), and default to previous month based on reconciling period
            gUnpackDateLong tgSpf.iBLastStdMnth(0), tgSpf.iBLastStdMnth(1), llLastInv
            llLastInv = llLastInv - 15      'get to middle of previous month
            slStr = Format$(llLastInv, "ddddd")
            '8-28-19 use csi calendar control vs edit box
            plcSelC1.Visible = False
            lacSelCFrom.Width = 1140
            lacSelCFrom.Caption = "Dates- From"
            lacSelCFrom.Visible = True
'            edcSelCFrom.Text = ""
'            edcSelCFrom.Left = 1320
'            edcSelCFrom.Visible = True
            CSI_CalFrom.Text = ""
            CSI_CalFrom.Move lacSelCFrom.Left + lacSelCFrom.Width + 120, lacSelCFrom.Top - 30
            CSI_CalFrom.Visible = True
            
'            lacSelCTo.Width = 360
            lacSelCTo.Caption = "To"
            lacSelCTo.Move CSI_CalFrom.Left + CSI_CalFrom.Width + 120, lacSelCFrom.Top, 360
            lacSelCTo.Visible = True
'            edcSelCTo.Text = ""
'
'            edcSelCTo.Move 3120, edcSelCFrom.Top   '1050
'            edcSelCTo.Visible = True
            ...
            gUnpackDateLong tgSpf.iBLastStdMnth(0), tgSpf.iBLastStdMnth(1), llLastInv
            llLastInv = llLastInv - 45      'get to middle of previous month
            slStr = Format$(llLastInv, "ddddd")
            
            If tgSpf.sRRP = "S" Then    'Standard month
'                edcSelCFrom.Text = gObtainStartStd(slStr)
'                edcSelCTo.Text = gObtainEndStd(slStr)
                CSI_CalFrom.Text = gObtainStartStd(slStr)
                CSI_CalTo.Text = gObtainEndStd(slStr)
            ElseIf tgSpf.sRRP = "C" Then    'Calendar
'                edcSelCFrom.Text = gObtainStartCal(slStr)
'                edcSelCTo.Text = gObtainEndCal(slStr)
                CSI_CalFrom.Text = gObtainStartCal(slStr)
                CSI_CalTo.Text = gObtainEndCal(slStr)
            Else    'Corporate
                ilRet = gObtainCorpCal()            'retrieve corp calendars in memory for COF
'                edcSelCFrom.Text = gObtainStartCorp(slStr, False)
'                edcSelCTo.Text = gObtainEndCorp(slStr, False)
                CSI_CalFrom.Text = gObtainStartCorp(slStr, False)
                CSI_CalTo.Text = gObtainEndCorp(slStr, False)
            End If

            ckcAll.Visible = False

            'deposit date (transaction date) is default
            If rbcSelCSelect(0).Value Then
                rbcSelCSelect_click 0   ', True
            Else
                rbcSelCSelect(0).Value = True
            End If
            plcSelC2.Visible = True
'            mAskCashTrMercProm edcSelCTo.Top + edcSelCTo.Height + 60, False  'hide hard cost option
            mAskCashTrMercProm CSI_CalFrom.Top + CSI_CalFrom.Height + 60, False  'hide hard cost option
            ...
            'default is by salesperson, only sort allowed
            If rbcSelC4(1).Value Then
                rbcSelC4_click 1    ', True
            Else
                rbcSelC4(1).Value = True
            ...
            mAskAirTimeNTR plcSelC3.Top + plcSelC3.Height
            rbcSelC6(2).Value = True                            'default to include air time and ntr
'            '7-9-03
'            gPopVehicleGroups RptSel!cbcSet1, tgVehicleSets1(), True
'            edcSet1.Text = "Vehicle Group Subsort"
'            cbcSet1.ListIndex = 0
...
'            edcCheck.Visible = True
            ...
            'plcSelC8.Move 120, plcSelC7.Top + plcSelC7.Height + 30
            smPlcSelC8P = "From"
            plcSelC8.Move 120, plcSelC6.Top + plcSelC6.Height + 30
            rbcSelC8(0).Move 470, 0, 900
            rbcSelC8(1).Move 1400, 0, 1400
            rbcSelC8(2).Move 2770, 0, 1200
            rbcSelC8(0).Caption = "History"
            ...
            plcSelC12.Move 120, plcSelC8.Top + plcSelC8.Height + 30
            smPlcSelC12P = "Totals by"
            rbcSelC12(0).Move 960, 0, 1080
            rbcSelC12(0).Caption = "Contract"
            rbcSelC12(1).Move 2160, 0, 1320
            rbcSelC12(1).Caption = "Transaction"
            rbcSelC12(0).Visible = True
            rbcSelC12(1).Visible = True
            If rbcSelC12(0).Value Then
                rbcSelC12_Click 0   ', True
            Else
                rbcSelC12(0).Value = True
            End If

            lacSort.Move 360, plcSelC12.Height + plcSelC12.Top + 480, 4000, 600
            lacSort.Caption = "Apply On Account Payments to their proper " & sgCR & sgLF & "invoices before running the report"
            lacSort.Font = "Arial"
            lacSort.FontSize = 8
            lacSort.FontItalic = True
            lacSort.FontBold = True
            lacSort.Visible = True
            plcSelC12.Visible = True
...
'            edcSelA.Move 2400, lacFromA.Top + 60
            CSI_CalDateA.Move 2400, lacFromA.Top + 60
            CSI_CalDateA.Visible = False
            lacFromA.Visible = False
            edcSelA.Visible = False
...
'            edcSelCTo.Move lacSelCTo.Left + 840, edcSelCFrom.Top
            ...
            CSI_CalTo.Text = Format$(gNow(), "m/d/yy")
            CSI_CalTo.Visible = True
            CSI_CalTo.Move lacSelCTo.Left + lacSelCTo.Width + 120, CSI_CalFrom.Top
...
'            edcSelCFrom.Left = 960
            ...
            lacSelCFrom.Width = 1200
            CSI_CalFrom.Move 1200, lacSelCFrom.Top - 30
            lacSelCTo.Move edcSelCFrom.Left + edcSelCFrom.Width + 360, lacSelCFrom.Top, 360
'            edcSelCTo.Move lacSelCTo.Left + 840, edcSelCFrom.Top
            CSI_CalTo.Move lacSelCTo.Left + lacSelCTo.Width + 120, CSI_CalFrom.Top

            mAskContract edcSelCFrom.Top + edcSelCFrom.Height, 120
            '7-7-17 Option to filter by Invoice #
            lacSelCFrom1.Move edcSelCTo1.Left + edcSelCTo1.Width + 360, lacSelCTo1.Top, 600
            lacSelCFrom1.Caption = "Inv#"
            edcLatestCashDate.Move CSI_CalTo.Left, edcSelCTo1.Top
            lacSelCFrom1.Visible = True
            edcLatestCashDate.Visible = True
            ...
            '8-1-17 add option to exclude the user name; when exporting it exports under advertiser due to subreport (?)
            ckcOption.Move 120, plcSelC12.Top + plcSelC12.Height, 2040
            ckcOption.Caption = "Include User Name"
            ckcOption.Value = vbChecked
            ckcOption.Visible = True
        ...
        Case COLL_POAPPLY
            mAskPOApply
        Case COLL_AGEMONTH
            ckcAll.Visible = False              'dont show any selectivity
            
            plcSelC6.Visible = True
            plcSelC6.Move 120, 120, 3000
            ckcSelC6Add(0).Caption = "Include Hard Cost"
            ckcSelC6Add(0).Move 0, 0, 2400
            ckcSelC6Add(0).Visible = True
            rbcSelC6(0).Visible = False
            rbcSelC6(1).Visible = False
            rbcSelC6(2).Visible = False
            pbcSelC.Visible = True

            'Date: 2020-02-24 added option to suppress zero balance RVF records
'            plcSelC9.Move plcSelC6.Left, plcSelC6.Top + plcSelC6.Height + 10, 3360, 500
'            ckcSuppressZB.Move 0, 0
'            plcSelC9.Visible = True
'            ckcSuppressZB.Visible = True
...
Public Sub mVehLabelsPop(llVehicletypes As Long)
    Dim ilRet As Integer
    ilRet = gPopUserVehicleBox(RptSel, llVehicletypes + ACTIVEVEH, lbcSelection(0), tgAirNameCode(), sgAirNameCodeTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mVehLabelsErr
        gCPErrorMsg ilRet, "mVehLabelsPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mVehLabelsErr:
...
Public Sub mSetPrintForEntryDate()
    ...
    slStartDate = RptSel!edcSelCFrom.Text   'earliest  date
    ...
    slEndDate = RptSel!edcSelCTo.Text   'Latest date
    If slEndDate = "" Then
    ...
    If ilRet <> BTRV_ERR_END_OF_FILE Then
        ...
        If RptSel!rbcSelC6(2).Value = False Then            'include both carted &  uncarted
        ...
        gBtrvErrorMsg ilRet, "gObtainCif (btrExtAddField):" & "Cif.Btr", RptSel
        On Error GoTo 0
        ilRet = btrExtGetNext(hmCif, tmCif, ilExtLen, llRecPos)
        If (ilRet <> BTRV_ERR_END_OF_FILE) And (ilRet <> BTRV_ERR_FILTER_LIMIT) Then
            On Error GoTo mObtainCifErr
            gBtrvErrorMsg ilRet, "gObtainCif (btrExtGetNextExt):" & "Cif.Btr", RptSel
            On Error GoTo 0
            ilExtLen = Len(tmCif)  'Extract operation record size
            Do While ilRet = BTRV_ERR_REJECT_COUNT
                ilRet = btrExtGetNext(hmCif, tmCif, ilExtLen, llRecPos)
...
Public Sub mAllConvAirSellPkgVehPop(ilIndex As Integer)
    Dim ilRet As Integer
    ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHAIRING + VEHSELLING + VEHPACKAGE + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)

    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mAllConvAirSellPkgVehPopErr
        gCPErrorMsg ilRet, "mAllConvAirSellPkgVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
...
Public Sub mConvVehPop(ilIndex As Integer)
    Dim ilRet As Integer
        ilRet = gPopUserVehicleBox(RptSel, VEHCONV_WO_FEED + VEHCONV_W_FEED + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mConvVehPopErr
        gCPErrorMsg ilRet, "mConvVehPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
mConvVehPopErr:
...
'        edcSelCTo.Visible = True
    ...
    If ilDefaultEndDate Then
        CSI_CalTo.Text = Format$(gNow(), "m/d/yy")
    End If
    CSI_CalTo.Move CSI_CalFrom.Left, CSI_CalFrom.Top + CSI_CalFrom.Height + 60
    CSI_CalTo.Visible = True
    Exit Sub
End Sub
...
Public Sub mLiveLogVehiclesPop(ilIndex As Integer)
    Dim ilRet As Integer
        ilRet = gPopUserVehicleBox(RptSel, VEHALLTYPES + VEHLIVELOG + ACTIVEVEH, lbcSelection(ilIndex), tgVehicle(), sgVehicleTag)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mLiveLogVehiclesPopErr
        gCPErrorMsg ilRet, "mLiveLogVehiclesPop (gPopUserVehicleBox: Vehicle)", RptSel
        On Error GoTo 0
    End If
    Exit Sub
...
'               For all ageing reports, ask Latest billing date to include, latest cash date to include,
'               mm/yy to use as current month, Include ageing earliest & latest mm/yy
'
Public Sub mAskAgeingDates()
    Dim slStr As String
'           8-28-19 use csi calendar vs edit box
    lacSelCTo.Visible = False
    edcSelCTo.Visible = False
    plcSelC1.Visible = False
    plcSelC2.Visible = False
    lacSelCFrom.Width = 3420
    lacSelCFrom.Caption = "Latest Billing Date to Include"
    lacSelCFrom.Visible = True
'            edcSelCFrom.Left = 3000
    CSI_CalFrom.Move 3000, lacSelCFrom.Top - 30
    lacLatestCashDate.Caption = "Latest Cash Date to Include"
    lacLatestCashDate.Move 120, edcSelCFrom.Top + edcSelCFrom.Height + 60, 3420
    lacLatestCashDate.Visible = True
'            edcLatestCashDate.Move 3000, edcSelCFrom.Top + edcSelCFrom.Height + 30, 1170
'            edcLatestCashDate.Visible = True
'            edcSelCFrom.Visible = True          'show latest billing edit box
    CSI_CalTo.Move 3000, CSI_CalFrom.Top + CSI_CalFrom.Height + 30
    CSI_CalTo.Visible = True
    CSI_CalFrom.Visible = True          'show latest billing edit box
    CSI_CalFrom.CSI_AllowBlankDate = True
    CSI_CalTo.CSI_AllowBlankDate = True
    gUnpackDate tgSpf.iRCRP(0), tgSpf.iRCRP(1), slStr
    If Trim$(slStr) <> "" Then
'                edcSelCFrom.Text = slStr            'latest billing date to include
'                edcLatestCashDate.Text = slStr
        CSI_CalFrom.Text = slStr            'latest billing date to include
        CSI_CalTo.Text = slStr
    Else
'                edcSelCFrom.Text = ""
'                edcLatestCashDate.Text = ""
        CSI_CalFrom.Text = ""
        CSI_CalTo.Text = ""
    End If
'            lacSelCFrom1.Move 120, edcLatestCashDate.Top + edcLatestCashDate.Height + 30, 3000
    lacSelCFrom1.Move 120, CSI_CalTo.Top + CSI_CalTo.Height + 30, 3000
    lacSelCFrom1.Caption = "MM/YY to use as current month"
    lacSelCFrom1.Visible = True

    mAskMMYY edcSelCFrom1

'            edcSelCFrom1.Move 3000, edcLatestCashDate.Top + edcLatestCashDate.Height + 60, 720
    edcSelCFrom1.Move 3000, CSI_CalTo.Top + CSI_CalTo.Height + 60, 720
    lacSelCFrom1.Top = edcSelCFrom1.Top + 30
    'edcSelCTo.Visible = True
    edcSelCFrom1.Visible = True
    'plcSelC1.Move 120, edcSelCTo.Top + edcSelCTo.Height
...
'*******************************************************
'*                                                     *
'*      Procedure Name:mPkgVehPop                      *
'*                                                     *
'*                                                     *
'*            Comments: Populate the selection combo   *
'*                      box for package vehicles       *
'*                                                     *
'*******************************************************
Private Sub mPkgVehPop()
    Dim ilRet As Integer
    Dim illoop As Integer
    
    'ilRet = gPopUserVehicleBox(RptSel, VEHPACKAGE + ACTIVEVEH + DORMANTVEH, lbcSelection(0), tgVehicle(), sgVehicleTag)
    For illoop = LBound(tgMVef) To UBound(tgMVef) - 1
        If tgMVef(illoop).sType = "P" And tgMVef(illoop).lPvfCode > 0 Then      'find only std pkg
            lbcSelection(10).AddItem Trim$(tgMVef(illoop).sName)
            lbcSelection(10).ItemData(lbcSelection(10).NewIndex) = tgMVef(illoop).iCode
        End If
    Next illoop
'    If ilRet <> CP_MSG_NOPOPREQ Then
'        On Error GoTo mPkgVehPopErr
'        gCPErrorMsg ilRet, "mPkgVehPop (gPopUserVehicleBox: Vehicle)", RptSel
'        On Error GoTo 0
'    End If
    Exit Sub
mPkgVehPopErr:
...
'                        ilListIndex = vbDefault selection
'                        ilIncludeNone - true to include "None" as a choice
Public Sub mFillStationPostSortList(cbcList As Control, ilListIndex As Integer, ilIncludeNone As Integer)
    If ilIncludeNone Then
        cbcList.AddItem "None"
    End If
    cbcList.AddItem "Invoice Date"
    cbcList.AddItem "Log-In Date"
    cbcList.AddItem "Vehicle"
    cbcList.ListIndex = ilListIndex
    Exit Sub
End Sub

Public Sub mAdvtAgySelection()
    lbcSelection(0).Visible = True
    Select Case lbcRptType.ListIndex
        Case 0  'Summary
            plcType.Visible = True      'detail or summary
...
Public Sub mVehicleListSelection()
    lbcSelection(0).Visible = True
    Select Case lbcRptType.ListIndex
        Case 0  'Summary
            mAllVehPop
        ...
        Case 5  'Participant
            ...
            lacCheck.Caption = "Effective Date"
            lacCheck.Visible = True
    '                        edcAsOfDate.Visible = True         '8-16-19  this isnot used here
            plcSelC4.Visible = True
            plcSelC4.Move 700, plcSelC3.Top + plcSelC3.Height + 50, 3000
            plcSelC4.ZOrder
            rbcSelC4(0).Visible = True
...
Public Sub mSalespeopleListSelection()
    Select Case lbcRptType.ListIndex
        Case 0  'Summary
            lbcSelection(1).Visible = False         'sales office
            lbcSelection(0).Visible = True          'salespeople
...
Sub gGenCreditStatusGRF()
    ...
    If ckcSel2(1).Value = 1 Then                                'select advt
        For ilTemp = 0 To lbcSelection(0).ListCount - 1 Step 1
            If RptSel!lbcSelection(0).Selected(ilTemp) Then
    ...
    If ckcSel2(0).Value = 1 Then                                'select agcy
        For ilTemp = 0 To lbcSelection(1).ListCount - 1 Step 1
            If RptSel!lbcSelection(1).Selected(ilTemp) Then
