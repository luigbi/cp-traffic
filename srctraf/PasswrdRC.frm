...
'   This is a duplicate of Password.frm (used in UserOpt)
Option Explicit
Option Compare Text
...
Private Sub cmcCancel_Click()
    RateCard!edcHiddenPassword.Text = ""
    mTerminate
End Sub
    ...
    If StrComp(slStr, smCurrentPassword, 1) = 0 Then
        ...
        If Len(slStr) > 0 Then
            ...
            If StrComp(slStr, slStr1, 1) = 0 Then
                RateCard!edcHiddenPassword.Text = slStr
            Else
...
'
    ...
    smCurrentPassword = RateCard!edcHiddenPassword.Text
    RateCard!edcHiddenPassword.Text = ""
    imTerminate = False
    imChgMode = False
    imBSMode = False
