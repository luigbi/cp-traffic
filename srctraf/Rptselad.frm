...
Begin VB.Form RptSelAD 
   Appearance      =   0  'Flat
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Audience Delivery"
   ClientHeight    =   5535
   ClientLeft      =   180
   ClientTop       =   1485
   ClientWidth     =   9270
   ...
   Begin VB.Frame frcOption 
      ...
      Begin VB.PictureBox pbcSelC 
         ...
         Begin V81TrafficReports.CSI_Calendar CSI_CalFrom 
            ...
            CSI_DefaultDateType=   0
         End
         Begin VB.PictureBox plcShowGrimps 
            Appearance      =   0  'Flat
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   240
            ...
            Top             =   3465
            Width           =   4455
            Begin VB.OptionButton rbcShowGrimps 
               Caption         =   "Thousands"
               ForeColor       =   &H80000008&
               Height          =   210
               Index           =   1
         ...
         Begin VB.TextBox edcContract 
            ...
            Width           =   1170
         End
         Begin VB.CheckBox ckcShowTime 
            Caption         =   "Show Air/Schedule Time"
            ForeColor       =   &H80000008&
            Height          =   270
            Left            =   0
            TabIndex        =   75
            ...
            Width           =   2415
         End
         Begin VB.CheckBox ckcBonusAud 
            Caption         =   "Show Audience Diff for Bonus/Free Spots"
            ForeColor       =   &H80000008&
            Height          =   270
            Left            =   1725
            TabIndex        =   74
            ...
            Width           =   2025
         End
         Begin VB.CheckBox ckcMGAud 
            Caption         =   "Show Audience Diff for MG"
            ForeColor       =   &H80000008&
            Height          =   270
            Left            =   690
            TabIndex        =   73
         ...
         Begin VB.PictureBox plcPledge 
            ...
            Top             =   2010
            Width           =   4275
            Begin VB.OptionButton rbcPledge 
               Caption         =   "Both"
               ForeColor       =   &H80000008&
               Height          =   210
               Index           =   2
            ...
            End
         End
         Begin VB.PictureBox plcOverUnder 
            Appearance      =   0  'Flat
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   240
            ...
            Top             =   1770
            Width           =   4275
            Begin VB.OptionButton rbcOverUnder 
               Caption         =   "Under Only"
               ForeColor       =   &H80000008&
               Height          =   210
               Index           =   1
         ...
         Begin VB.PictureBox plcCPPCPM 
            ...
            Top             =   1530
            Width           =   4455
            Begin VB.OptionButton rbcCPPCPM 
               Caption         =   "Gross Impressions"
               ForeColor       =   &H80000008&
               Height          =   210
               Index           =   1
               Left            =   2400
         ...
         Begin VB.PictureBox plcSortBy 
            ...
            End
         End
         Begin VB.PictureBox plcSubsort 
            Appearance      =   0  'Flat
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   480
            ...
            Top             =   1050
            Width           =   4275
            Begin VB.OptionButton rbcSubsort 
               Caption         =   "Over/Under (desc)"
               ForeColor       =   &H80000008&
               Height          =   210
               Index           =   2
   ...
   End
End
Attribute VB_Name = "RptSelAD"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of Rptselad.frm on Wed 6/17/09 @ 12:56 P
...
'
' File Name: RptSelAD.Frm           Audience Delivery
'
' Release: 1.0
'
' Description:
...
Dim smPlcSpotTypes As String
Dim smPlcSortBy As String
Dim smPlcShowGrimps As String
'
'       mSpotTypeSelectivity - format spot type selectivity for report screen
'
Public Sub mSpotTypeSelectivity()
    'plcSpotTypes.Move 0, ckcNewPage.Top + plcSortBy.Height
    plcSpotTypes.Height = 655                   '3 lines of check boxes
    ...
    ckcSelC5(7).Move 3550, 210, 870
    ckcSelC5(7).Visible = True             'this includes spot rate types (sched line rate) and spot type (SDF) = "G"
    ckcSelC5(8).Value = vbUnchecked   'True
    ckcSelC5(8).Caption = "Recapturable"
    ckcSelC5(8).Move 720, 435, 1470
    ckcSelC5(8).Visible = True
    ckcSelC5(8).Value = vbUnchecked   'True
    ckcSelC5(9).Value = vbUnchecked   'True
    ckcSelC5(9).Caption = "Spinoff"
    ckcSelC5(9).Move 2280, 435, 1000
    ckcSelC5(9).Visible = True  '9-12-02 vbChecked   'True
    ckcSelC5(10).Caption = "Missed"
    ckcSelC5(10).Move 3280, 435, 960
    ckcSelC5(10).Value = vbUnchecked
    ckcSelC5(10).Visible = True
    plcSpotTypes.Visible = True
...
Private Sub cmcGen_Click()
    ...
    For ilJobs = ilStartJobNo To ilNoJobs Step 1
        igJobRptNo = ilJobs
        If Not gGenReportAD(ilListIndex) Then
            igGenRpt = False
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set RptSelAD = Nothing   'Remove data segment
...
Dim ilListIndex As Integer
    ...
    If ilListIndex = DELIVERY_POSTBUY Then
        ...
        lbcSelection(1).Move 15, ckcAll.Top + ckcAll.Height + 30, 4000, 3000
        lbcSelection(0).Visible = True
        lbcSelection(0).Move lbcSelection(1).Left, ckcAll.Top + ckcAll.Height + 30, 4000, 3000
        ckcAllCntrs.Visible = False
        plcSortBy.Height = 240
        rbcSortby(2).Visible = False
        rbcSortby(3).Visible = False

        ckcNewPage.Move plcSortBy.Left, plcSortBy.Top + plcSortBy.Height, 2505
        ckcNewPage.Visible = True
        plcSpotTypes.Move plcSortBy.Left, ckcNewPage.Top + ckcNewPage.Height
        plcSpotTypes.Height = 655                   '3 lines of check boxes
        mSpotTypeSelectivity
        plcSpotTypes.Visible = True
        plcSubsort.Visible = False
        plcCPPCPM.Visible = False
        plcOverUnder.Visible = False
        plcPledge.Visible = False
        plcBook.Visible = False
        rbcSortby(1).Caption = "Contract"
        rbcSortby(0).Left = 960
        rbcSortby(1).Left = 2160
        smPlcSortBy = "Totals by"

        ckcMGAud.Move plcSortBy.Left, plcSpotTypes.Top + plcSpotTypes.Height + 30
        ckcMGAud.Visible = True
        ckcBonusAud.Move plcSortBy.Left, ckcMGAud.Top + ckcMGAud.Height, 4000
        ckcBonusAud.Visible = True
        ckcShowTime.Move plcSortBy.Left, ckcBonusAud.Top + ckcBonusAud.Height
        ckcShowTime.Visible = True

        smPlcShowGrimps = "Show Impressions by- "
        plcShowGrimps.Move plcSortBy.Left, ckcShowTime.Top + ckcShowTime.Height
        rbcShowGrimps(0).Move 2040
        rbcShowGrimps(1).Move 2880
        rbcShowGrimps(0).Visible = True
        rbcShowGrimps(1).Visible = True
        plcShowGrimps.Visible = True
        'edcContract.Move 1080, ckcShowTime.Top + ckcShowTime.Height
        edcContract.Move 1080, plcShowGrimps.Top + plcShowGrimps.Height
        lacContract.Move plcSortBy.Left, edcContract.Top + 30
        lacContract.Visible = True
        edcContract.Visible = True
    ElseIf ilListIndex = DELIVERY_AUDIENCE Then     'questions are already formatted on form
        smPlcSortBy = "Sort by"
        plcSpotTypes.Visible = False
...
'
    ...
    For ilLoop = 0 To lbcSelection(1).ListCount - 1 Step 1
        If lbcSelection(1).Selected(ilLoop) Then
            ...
            ilRet = gPopCntrForAASBox(RptSelAD, 0, ilAdfCode, slCntrStatus, slCntrType, ilCurrent, ilHOState, ilShow, lbcMultiCntr, tgMultiCntrCodeAD(), sgMultiCntrCodeTagAD)
            If ilRet <> CP_MSG_NOPOPREQ Then
                On Error GoTo mCntrPopErr
                gCPErrorMsg ilRet, "mCntrPop (gPopCntrBox)", RptSelAD
                On Error GoTo 0
            End If
...
Dim slStr As String
    ...
    RptSelAD.Caption = smSelectedRptName & " Report"
...
Private Sub mInitReport()
    ...
    mAdvtPop RptSelAD, lbcSelection(1)
    lbcSelection(0).Tag = ""
    lbcSelection(1).Tag = ""
    ilVefCode = 0
    ...
    frcOption.Enabled = True
    lbcRptType.AddItem "Audience Delivery", 0
    lbcRptType.AddItem "Post Buy Analysis", 1
...
Private Sub mParseCmmdLine()
    ...
    'End If
    'gInitStdAlone RptSelAD, slStr, ilTestSystem
...
'
    ...
    If ilListIndex = DELIVERY_AUDIENCE Then             'audience delivery
        If ckcAll.Value = vbChecked Then                   'all advt/cntrs, date required
'            If edcSelCFrom.Text <> "" And edcSelCTo.Text <> "" Then
            If CSI_CalFrom.Text <> "" And CSI_CalTo.Text <> "" Then     '9-3-19 use csi cal control vs edit box
                ilEnable = True
            End If
...
Private Sub plcShowGrimps_Paint()
    plcShowGrimps.CurrentX = 0
    plcShowGrimps.CurrentY = 0
    plcShowGrimps.Print smPlcShowGrimps
End Sub

Private Sub plcSpotTypes_Paint()
    smPlcSpotTypes = "Include"
    plcSpotTypes.Cls
    plcSpotTypes.CurrentX = 0
    plcSpotTypes.CurrentY = 0
    plcSpotTypes.Print smPlcSpotTypes
End Sub
...
Private Sub plcBook_Paint()
    ...
    plcBook.Print "Use"
End Sub
Private Sub plcPledge_Paint()
    plcPledge.CurrentX = 0
    plcPledge.CurrentY = 0
    plcPledge.Print "Include"
End Sub
Private Sub plcOverUnder_Paint()
    plcOverUnder.CurrentX = 0
    plcOverUnder.CurrentY = 0
    plcOverUnder.Print "Include"
End Sub
Private Sub plcCPPCPM_Paint()
    plcCPPCPM.CurrentX = 0
    plcCPPCPM.CurrentY = 0
    plcCPPCPM.Print "Show"
End Sub
Private Sub plcSortBy_Paint()
    plcSortBy.CurrentX = 0
    plcSortBy.CurrentY = 0
    plcSortBy.Print smPlcSortBy
End Sub
Private Sub plcSubsort_Paint()
    plcSubsort.CurrentX = 0
    plcSubsort.CurrentY = 0
    plcSubsort.Print "If Slsp, Subsort by"
End Sub
