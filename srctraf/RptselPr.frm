...
Begin VB.Form RptSelPr 
   ...
   Begin VB.Frame frcOption 
      ...
      Begin VB.PictureBox pbcSelC 
         ...
         Visible         =   0   'False
         Width           =   4500
         Begin VB.CheckBox ckcUseDefault 
            Caption         =   "Use vehicle default book if line undefined"
            Height          =   255
            Left            =   120
            TabIndex        =   36
            Top             =   1680
            Width           =   3735
         End
         Begin VB.PictureBox plcWhichRate 
            Appearance      =   0  'Flat
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   255
            ...
            Top             =   1320
            Width           =   3450
            Begin VB.OptionButton rbcWhichRate 
               Caption         =   "Proposal"
               ForeColor       =   &H80000008&
               Height          =   210
               Index           =   1
   ...
   End
End
Attribute VB_Name = "RptSelPr"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of RptselPr.frm on Wed 6/17/09 @ 12:56 P
...
'
' File Name: RptSelPR.Frm - Proposal Research Recap
'                           Dump research data from contract header & sch lines
'                           6-15-04
'
'
'
...
Private Sub cmcGen_Click()
    ...
    ilNoJobs = 1
    ilStartJobNo = 1
    slJobName = "PropRRDt.rpt"
    If rbcSel(1).Value Then
        slJobName = "PropRRSm.rpt"
    End If
    For ilJobs = ilStartJobNo To ilNoJobs Step 1
        ...
        If Trim$(slJobName) = "PropRRDt.rpt" Then           'option only for detail version
            If rbcWhichRate(0).Value Then         'use actual rate
                If Not gSetFormula("WhichRate", "'A'") Then
                    mReset
                    Exit Sub
                End If
            Else  'use Proposal rate
                If Not gSetFormula("WhichRate", "'P'") Then
                    mReset
                    Exit Sub
                End If
            End If
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set RptSelPr = Nothing   'Remove data segment
...
Dim slStr As String
    ...
    RptSelPr.Caption = smSelectedRptName & " Report"
...
Private Sub mInitReport()
    ...
    ilRet = gSocEcoPop(RptSelPr, cbcSet1)
...
Private Sub mParseCmmdLine()
    ...
    'End If
    'gInitStdAlone RptSelPr, slStr, ilTestSystem
...
Private Sub plcWhichRate_Paint()
    plcWhichRate.CurrentX = 0
    plcWhichRate.CurrentY = 0
    plcWhichRate.Print "Use Rate"
End Sub
...
Private Sub rbcSel_Click(Index As Integer)
    ...
    If Index = 0 Then               'detail vs summary
        plcWhichRate.Visible = True
    Else
        plcWhichRate.Visible = False
        rbcWhichRate(0).Value = True
    End If
End Sub
