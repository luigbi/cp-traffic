...
Begin VB.Form RptSelSN 
   Appearance      =   0  'Flat
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Split Network Avails Report Selection"
   ClientHeight    =   5535
   ClientLeft      =   165
   ClientTop       =   1305
   ClientWidth     =   9270
   ...
   Begin VB.ListBox lbcRptType 
      Appearance      =   0  'Flat
      Height          =   240
      ItemData        =   "rptselsn.frx":0000
      Left            =   6120
      List            =   "rptselsn.frx":0002
      TabIndex        =   70
      Top             =   360
      Visible         =   0   'False
      Width           =   1185
   ...
   Begin VB.Frame frcOption 
      Caption         =   "Split Network Avails Selection"
      Enabled         =   0   'False
      ForeColor       =   &H00000000&
      Height          =   4035
      Left            =   75
      ...
      Begin VB.PictureBox pbcSelC 
         ...
         Begin VB.CheckBox ckcNewPage 
            Caption         =   "Skip to New Page each Week"
            ForeColor       =   &H80000008&
            Height          =   270
            Left            =   150
            TabIndex        =   71
      ...
      Begin VB.PictureBox pbcOption 
         ...
         Begin VB.ListBox lbcSelection 
            Appearance      =   0  'Flat
            Height          =   3390
            ItemData        =   "rptselsn.frx":0004
            Left            =   285
            List            =   "rptselsn.frx":000B
   ...
   End
End
Attribute VB_Name = "RptSelSN"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of rptselsn.frm on Wed 6/17/09 @ 12:56 P
'***** Mode: AutoSelect Standard Mode (Internal References Only)***************************
'******************************************************************************************
'* Note: VBC id'd the following unreferenced items and handled them as described:         *
'*                                                                                        *
'* Private Variables (Removed)                                                            *
'*  smLogUserCode                 smRateCardTag                                           *
'*                                                                                        *
...
'
' File Name: RptSelSN.Frm - Split Network Avails Report
'
'
' Release: 4.7  9/25/00
'
...
'Rate Card
Private Sub mSellConvPop()
    Dim ilRet As Integer

    ilRet = gPopUserVehicleBox(RptSelSN, VEHCONV_WO_FEED + VEHCONV_W_FEED + VEHSELLING + ACTIVEVEH, lbcSelection, tgCSVNameCode(), sgCSVNameCodeTag)    'lbcCSVNameCode)
    If ilRet <> CP_MSG_NOPOPREQ Then
        On Error GoTo mSellConvPopErr
        gCPErrorMsg ilRet, "mSellConvPop (gPopUserVehicleBox: Vehicle)", RptSelSN
        On Error GoTo 0
    End If
    Exit Sub
mSellConvPopErr:
...
Private Sub cmcGen_Click()
    ...
    For ilJobs = ilStartJobNo To ilNoJobs Step 1
        igJobRptNo = ilJobs
        If Not gOpenPrtJob("SplitAvails.Rpt") Then
            igGenRpt = False
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set RptSelSN = Nothing   'Remove data segment
...
Dim slStr As String
    ...
    RptSelSN.Caption = smSelectedRptName & " Report"
    ...
    imSetAll = True
    'ckcAll.Move 120, 0
    'lbcSelection.Move 120, ckcAll.Height + 30, 4200, 1650

    'pbcSelC.Move 90, 255, 4515, 3360
    lbcSelection.Visible = True
    lbcSelection.Visible = True

    plcCTypes.Move 120, edcSelCFrom.Top + edcSelCFrom.Height + 60
    plcSpots.Move 120, plcCTypes.Top + plcCTypes.Height
    plcSort.Move 120, plcSpots.Top + plcSpots.Height
    ckcNewPage.Move 120, plcSort.Top + plcSort.Height
    gCenterStdAlone RptSelSN
End Sub
'*******************************************************
'*                                                     *
...
Private Sub mInitReport()
    ...
    lbcSelection.Tag = ""
    mSellConvPop
    gPopVehicleGroups RptSelSN!cbcGroup, tgVehicleSets1(), True
    ...
    lbcRptType.Clear
    lbcRptType.AddItem "Split Network Avails", 0
...
Private Sub mParseCmmdLine()
    ...
    'End If
    'gInitStdAlone RptSelSN, slStr, ilTestSystem
    'If igStdAloneMode Then
    '    smSelectedRptName = "Split Network Avails Report"
...
'
    ...
    If (edcSelCFrom.Text <> "") And (edcSelCFrom1.Text <> "") Then
        ...
        If ilEnable Then
            ilEnable = False
            For ilLoop = 0 To lbcSelection.ListCount - 1 Step 1      'budget entry must be selected
...
Private Sub rbcSort_Click(Index As Integer)
    If Index = 0 Then
        ckcNewPage.Caption = "Skip to New Page Each Week"
    Else
        ckcNewPage.Caption = "Skip to New Page Each Vehicle"
    End If
End Sub
