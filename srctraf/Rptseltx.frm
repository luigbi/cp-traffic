...
Begin VB.Form RptSelTx 
   ...
   End
End
Attribute VB_Name = "RptSelTx"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of Rptseltx.frm on Wed 6/17/09 @ 12:56 P
...
'
' File Name: RptSelTx.Frm   Dump Text file report
'
' Release: 4.7
'
' Description:
...
Private Sub cmcGen_Click()
    ...
    For ilJobs = ilStartJobNo To ilNoJobs Step 1
        igJobRptNo = ilJobs
        If Not gGenReportTx(ilListIndex) Then
            igGenRpt = False
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set RptSelTx = Nothing   'Remove data segment
...
Private Sub mInit()
    ...
    imAllClicked = False
    imSetAll = True
    'gCenterStdAlone RptSelTx
    'RptSelTx.Move -90, -90, 30, 30      'make form small and out of the way so its not seen
    RptSelTx.Move -330, -330, 30, 30      'make form small and out of the way so its not seen
End Sub
'*******************************************************
'*                                                     *
...
Private Sub mParseCmmdLine()
    ...
    '    slCommand = "Logs^Test\Guide\" & slReportCallType & "\" & slReportType & "\" & slDisPlayPrint & "\" & slCommGenDate & "\" & slCommGenTime
    '    imShowHelpmsg = False
    'Else
    ...
    'End If
    'gInitStdAlone RptSelTx, slStr, ilTestSystem
