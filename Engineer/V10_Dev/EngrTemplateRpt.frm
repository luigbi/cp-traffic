...
Begin VB.Form EngrTemplateRpt 
   ...
   Begin VB.Frame frcOption 
      ...
      Begin VB.ListBox lbcSubLib 
         Height          =   2985
         ItemData        =   "EngrTemplateRpt.frx":0000
         Left            =   5280
         List            =   "EngrTemplateRpt.frx":0002
      ...
      Begin VB.ListBox lbcLibrary 
         Height          =   2985
         ItemData        =   "EngrTemplateRpt.frx":0004
         Left            =   3120
         List            =   "EngrTemplateRpt.frx":0006
         MultiSelect     =   2  'Extended
         Sorted          =   -1  'True
         TabIndex        =   21
         TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "EngrTemplateRpt"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'**************************************************************************
'*  EngrTemplateRpt - Create a report to show template names
'
'*
    ...
    If optOldNew(0).Value = True Then           'current
        ...
        For llLoopLib = 0 To lbcLibrary.ListCount - 1
            If lbcLibrary.Selected(llLoopLib) Then          'test if user selected this entry
                ...
                ilRet = gGetRecs_DHE_DayHeaderInfoByLibrary(slDHEStamp, llLibCode, "EngrTemplateRpt: cmdReport", tlDHE())
     ...
     Else
        ...
        ilRet = gGetTypeOfRecs_AIE_ActiveInfo("DHE", slSQLChgDateFrom, slSQLChgDateTo, slAIEStamp, "EngrTemplateRpt", tlAIE())
        For ilAIELoop = LBound(tlAIE) To UBound(tlAIE) - 1
            ...
            For ilPass = 1 To 2
                ...
                End If
                ilRet = gGetRec_DHE_DayHeaderInfo(llLibCode, "EngrTemplateRpt: gGetRec_DHE_DayHeaderINfo- cmdReport", tmDHE)
                If ilPass = 1 Then
...
Private Sub Form_Initialize()
    ...
    gSetFonts EngrTemplateRpt
    gCenterForm EngrTemplateRpt
End Sub
...
Private Sub mPopLibraryNames()
    ...
    ilRet = gGetTypeOfRecs_DNE_DayName("C", "T", sgCurrDNEStamp, "EngrTemplateRpt-mPopulate Library Definition", tgCurrDNE())
    lbcLibrary.Clear
...
Dim ilRet As Integer
    ...
    ilRet = gGetTypeOfRecs_DHE_DayHeaderInfo("C", "T", sgCurrLibDHEStamp, "EngrTemplateRpt-lbcLibrary_click", tgCurrLibDHE())
...
'
'
'           mPopSubLib - populate the subnames.  If user selected one template, populate
'           with only those subnames that reference the template name.
...
Dim llLoopDSE As Long
    ...
    ilRet = gGetTypeOfRecs_DSE_DaySubName("C", sgCurrDSEStamp, "EngrTemplateRpt-mPopDSE Day Subname", tgCurrDSE())
    lbcSubLib.Clear
...
Dim ilRet As Integer
    ...
    If lbcLibrary.SelCount = 1 Then     'only one selected
        ...
        'ilRet = gGetTypeOfRecs_DHE_DayHeaderInfo("C", "L", sgCurrLibDHEStamp, "EngrTemplateRpt-lbcLibrary_click", tgCurrLibDHE())
...
Dim ilValidDates As Integer
    ...
    If ilFoundSub And tmDHE.sCurrent <> "N" Then        'passed all tests, must be current version
        mfilterSelectivity = True
    Else
        mfilterSelectivity = False
    End If
End Function
'           Create a record in the active data source for printing Template crystal report
...
'                           Template Name,
'                           original Template record (to keep all version together);
...
Dim ilBusCode As Integer
    ...
    ilRet = gGetRec_CTE_CommtsTitle(tmDHE.lCteCode, "EngrTemplateRpt-cmdReport_click for CTE", tmCTE)
