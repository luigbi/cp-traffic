...
Begin VB.Form EngrBUZip 
   ...
   End
End
Attribute VB_Name = "EngrBUZip"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'******************************************************************************************
'***** VB Compress Pro 6.11.32 generated this copy of EngrBUZip.frm on Wed 6/17/09 @ 12:56 PM *
...
Private Sub cmcStart_Click()
    ...
    Dim slEngineerINIPathName As String
    ...
    slEngineerINIPathName = sgDBPath & "Engineer.ini"
    ilRet = csiStartBackup(sgDBPath, slEngineerINIPathName, 3)
    If ilRet <> 0 Then
        If ilRet = 8001 Then
