...
Sub mLoadCbcToName()
    ...
    tmEmpEmails(1).Name = "Christine Curiel"
    tmEmpEmails(2).Name = "Anna Dow"
    tmEmpEmails(3).Name = "Eric Garst"
    tmEmpEmails(4).Name = "Mary Nelson"
    tmEmpEmails(5).Name = "Martina Patterson"
    tmEmpEmails(6).Name = "Melinda Lachance Pomeroy"
    tmEmpEmails(7).Name = "Sara Schones"
    tmEmpEmails(8).Name = "Brooke Townsend"
    tmEmpEmails(9).Name = "Service Department"

    tmEmpEmails(0).eMail = "norabrowne@counterpoint.net"
    tmEmpEmails(1).eMail = "christinecuriel@counterpoint.net"
    tmEmpEmails(2).eMail = "annadow@counterpoint.net"
    tmEmpEmails(3).eMail = "ericgarst@counterpoint.net"
    tmEmpEmails(4).eMail = "marynelson@counterpoint.net"
    tmEmpEmails(5).eMail = "martinapatterson@counterpoint.net"
    tmEmpEmails(6).eMail = "melindalachance@counterpoint.net"
    tmEmpEmails(7).eMail = "saraschones@counterpoint.net"
    tmEmpEmails(8).eMail = "brooketownsend@counterpoint.net"
    tmEmpEmails(9).eMail = "service@counterpoint.net"
...
'        .ToName = txtToName.Text
        ...
        If bmIsZip Then
            .Success = .Send(lstSendings, zpcDZip)
        Else
            .Success = .Send(lstSendings)
        End If
    End With
    If omEmailer.Success Then
        lstSendings.AddItem omEmailer.AdditionalMessageIfSuccess
    Else
        lstSendings.AddItem omEmailer.AdditionalMessageIfFail
    End If
